        ...
        if ($request->enter_otp != Session::get('otp')) {
            ...
            if ($getUserDetails) {
                if ($getUserDetails) {
                    ...
                    $status = $getUserDetails->status;
                    $wps = $getUserDetails->wps;
                    $vendor_safety_mis = $getUserDetails->vendor_safety_mis;
                    $accoss_location = $getUserDetails->accoss_location;
                    $plant_wise = $getUserDetails->plant_wise;
                    $division_wise = $getUserDetails->division_wise;
                    $inclusion = $getUserDetails->inclusion_initiator;
                    $silo_role = $getUserDetails->silo_role;
                    ...
                    $session_data = array(
                        ...
                        'status' => $status,
                        'wps' => $wps,
                        'vendor_safety_mis' => $vendor_safety_mis,
                        'accoss_location' => $accoss_location,
