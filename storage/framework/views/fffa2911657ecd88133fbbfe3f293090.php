...
<?php $__env->startSection('breadcrumbs'); ?>
    ...
    <li class="breadcrumb-item"><a href="<?php echo e(route('admin.vendor_esic_details.index')); ?>">List of SILO Tanker</a>
    </li>
...
<?php else: ?>
    ...
    <?php $__env->startSection('content'); ?>
        ...
        <div style="width: 100%; overflow: hidden;">
            <iframe id="myIframe" src="<?php echo e(url('vendor_silo/create_ifream/' . $id)); ?>"
...
<?php echo $__env->make('admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\8.4 php\htdocs\jamipol\resources\views/admin/vendor_silo/create.blade.php ENDPATH**/ ?>