...
<?php $__env->startSection('breadcrumbs'); ?>
    ...
    <li class="breadcrumb-item"><a href="<?php echo e(route('admin.request_permit.create')); ?>">Request Permit</a></li>
<?php $__env->stopSection(); ?>
<?php $__env->startSection('content'); ?>

    <form action="<?php echo e(route('admin.request_permit.store')); ?>" method="post" autocomplete="off">
        <?php echo csrf_field(); ?>
        ...
        <?php if(Session::get('user_typeSession') == 1): ?>
            <div class="form-group row">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <select class="form-control" id="p_req_name" name="supervisor_name" required>
                        <?php if($vendor_supervisors->count() > 0): ?>
                            <option value="null">Select Requester </option>
                            <?php $__currentLoopData = $vendor_supervisors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $vendor_supervisor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($vendor_supervisor->id); ?>"><?php echo e($vendor_supervisor->supervisor_name); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        <?php endif; ?>
                    </select>
                </div>
...
<?php $__env->startSection('scripts'); ?>
    ...
    <script>
        $("#getvalidity").on("click", function (e) {
            ...
            $.ajax({
                type: 'GET',
                url: "<?php echo e(route('admin.getvalidity')); ?>/" + o_ID,
        ...
        $('#departmentID').on('change', function () {
            ...
            if (Dept_ID) {
                ...
                $.ajax({
                    type: 'GET',
                    url: "<?php echo e(route('admin.getjob')); ?>/" + Div_ID + "/" + Dept_ID,
                    contentType: 'application/json',
                    dataType: "json",
                    success: function (data) {
                        // console.log(data);
                ...
                $.ajax({
                    type: 'GET',
                    url: "<?php echo e(route('admin.getIssuer')); ?>/" + Div_ID,
                    contentType: 'application/json',
                    dataType: "json",
        ...
        $('#six_directional1').on('change', function () {
            ...
            if (jobID == "0") {
                ...
                if (jobID) {
                    ...
                    $.ajax({
                        type: 'GET',
                        url: "<?php echo e(route('admin.getHaz')); ?>/" + jobID + "/" + six_directional,
                        contentType: 'application/json',
                        dataType: "json",
                        success: function (data) {
                            // console.log(data);
        ...
        $('#jobID').on('change', function () {
            ...
            if (jobID) {
                ...
                $.ajax({
                    type: 'GET',
                    url: "<?php echo e(route('admin.getSwpNumber')); ?>/" + job_ID,
                    contentType: 'application/json',
                    dataType: "json",
                    success: function (data) {
                        // console.log(data);
                        $("#swp_no").html(data.swp_num);
                        // $("#swp_file").append('<a href="../../'+data.swp_file+'" target="_blank"><img src="<?php echo e(URL::to('/images/pdf_download.png')); ?>"></a>');
                        for (var i = 0; i < data.swp_f.length; i++) {
                            var link = data.swp_f[i].swp_file;
                            let result = link.replace("public/", '');
                            $("#swp_file").append('<a href="../../' + result + '" target="_blank"><img src="<?php echo e(URL::to('/images/pdf_download.png')); ?>"></a>');
                        }
                    }
                });
            }
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\8.4 php\htdocs\jamipol\resources\views/admin/request_permits/create.blade.php ENDPATH**/ ?>