...
<?php $__env->startSection('breadcrumbs'); ?>
    ...
    <li class="breadcrumb-item"><a href="<?php echo e(route('admin.vendor_esic_details.index')); ?>">List of Vendor Bonus Return / Filling
            Documents</a>
    </li>
    <li class="breadcrumb-item active" aria-current="page">Upload Bonus Return / Filling Documents</li>
...
<?php else: ?>
    ...
    <?php $__env->startSection('content'); ?>
        ...
        <?php if($islast_date == 'yes'): ?>
            <div class="alert"
                style="background-color: #f8d7da; color: #842029; border: 1px solid #f5c2c7; border-radius: 6px; padding: 12 20px; font-weight: 600; box-shadow: 0 2px 6px rgba(216, 123, 130, 0.3); font-family: Arial, sans-serif;">
                Bonus return upload is not available for this month, you are unable to upload the file.
            </div>

        <?php endif; ?>
        <?php if(session('message')): ?>
            <div class="alert <?php echo e(session('message') == 'ECM uploaded successfully.' ? 'alert-success' : 'alert-danger'); ?>">
        ...
        <form action="<?php echo e(route('admin.vendor_ecm.store')); ?>" method="post" enctype="multipart/form-data" id="form"
            autocomplete="off">
            <?php echo csrf_field(); ?>
            ...
            <div class="col-md-12 mb-4">
                <h3 class="fw-bold">
                    <i class="fas fa-upload" style="color: #2c62a0;"></i> Vendor Bonus Return / Filling Document
                </h3>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="custom-file-upload text-center" id="uploadArea1">
                            <h5 class="text-primary fw-bold mb-3 p-2">Form C</h5>
                    ...
                    <div class="col-md-6">
                        <div class="custom-file-upload text-center" id="uploadArea2">
                            <h5 class="text-primary fw-bold mb-3 p-2">Form D</h5>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\8.4 php\htdocs\jamipol\resources\views/admin/vendor_ecm/create.blade.php ENDPATH**/ ?>