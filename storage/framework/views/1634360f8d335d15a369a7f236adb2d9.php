...
<?php $__env->startSection('content'); ?>
    ...
    <div class="card-body">
        ...
        <?php endif; ?>
        <?php if($labour_capacity <= $gp_count): ?>
                ...
                <div class="form-group row" style="display:none;">
                    ...
                    <div class="col-sm-10">
                        <select class="form-control rec " id="" name="">
                            ...
                            <?php if($workorder_code->count() > 0): ?>
                                <?php $__currentLoopData = @$workorder_code; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $work_order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e(@$work_order->order_code); ?>"><?php echo e(@$work_order->order_code); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            <?php endif; ?>
                        </select>
                    </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\8.4 php\htdocs\jamipol\resources\views/CLMSGatepass.blade.php ENDPATH**/ ?>