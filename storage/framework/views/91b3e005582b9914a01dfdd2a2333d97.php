...
$vms_flow = DB::table('vehicle_pass_flow')->where('vehicle_pass_id', $vms->id)->where('type_status', 'Return')->where('level', '0')->where('status', 'N')->first();
    ...
    <div class="container mt-4 pb-4">
        ...
        <div class="mb-4">
            <h3 class="fw-bold text-dark">
                ...
                <?php echo e($type); ?> Vehicle Gate Pass Management System (Surrender)
            </h3>
        ...
        <div class="row g-3">
            ...
            <div class="col-md-12">
                ...
                <a href="<?php echo e(asset($vms->vehicle_registration_doc)); ?>" target="_blank"
                    class="btn btn-outline-primary btn-sm">View Document</a>
            </div>
        </div>
        ...
        <div class="row g-3 mt-12">
            ...
            <div class="col-md-12">
                ...
                <input type="date" class="form-control hd" value="<?php echo e($vms->insurance_valid_to); ?>" name="insurance_to">
        ...
        <div class="form-group">
            ...
            <select class="form-control hd" name="vehicle_category" id="vehicle_category" required>
                ...
                <?php if($type == 'Employee'): ?>
                    <option <?php echo e($not_required ?? ''); ?> value="Diesel" <?php if($vms->vehicle_type == 'Diesel'): ?><?php echo e('selected'); ?><?php endif; ?>>🛢️
                        Diesel</option>
                    <option <?php echo e($not_required ?? ''); ?> value="CNG" <?php if($vms->vehicle_type == 'CNG'): ?><?php echo e('selected'); ?><?php endif; ?>>🧯 CNG
                    </option>
                <?php endif; ?>
                <option value="EV" <?php if($vms->vehicle_type == 'EV'): ?><?php echo e('selected'); ?><?php endif; ?>>🔌 EV</option>
                <?php if($type == 'Employee'): ?>
                    <option <?php echo e($not_required ?? ''); ?> value="Hybrid" <?php if($vms->vehicle_type == 'Hybrid'): ?><?php echo e('selected'); ?><?php endif; ?>>♻️
                        Hybrid</option>
                <?php endif; ?>
        ...
        <div class="row g-3 mt-2">
            ...
            <div class="col-md-12">
                ...
                <input type="date" class="form-control hd" value="<?php echo e($vms->license_valid_to); ?>" name="license_valid_to">
            </div>
            <div class="col-md-12 dn">
...
<?php
    $vehiclePassFlows = DB::table('vehicle_pass_flow')
        ...
        ->where('status', 'Y')
        ->where('type_status', 'Return')
        ->get();
?>

<?php $__empty_1 = true; $__currentLoopData = $vehiclePassFlows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $vms1): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
        ...
        <div class="row mb-4">
            <div class="col-md-6">
                ...
                <input type="text" class="form-control"
                    value="<?php echo e(ucfirst($vms1->desion ?? 'Edited/Corrected  by Vendor')); ?>" disabled>
            </div>
            <div class="col-md-6">
...
<?php if($user_check_safety->clm_role == 'Safety_dept'): ?>
    ...
    <?php  
        $flow = DB::table('vehicle_pass_flow')->where('vehicle_pass_id', $vms->id)->where('status', 'N')->where('level', '!=', '0')->where('type_status', 'Return')->first();
    ?>
...
<script>
    document.getElementById('form_return').addEventListener('submit', function (e) {
        ...
        fetch('<?php echo e(route("vms_ifream.update_return")); ?>', {
            method: 'POST',
            headers: {
...
<script>
    ...
    document.getElementById('hr_form').addEventListener('submit', function (e) {
        ...
        const formData = new FormData(form);
        formData.append('_method', 'POST'); // Laravel method spoofing for update

        fetch('<?php echo e(route("vms_ifream.update_return_approval", $vms_details->id)); ?>', {
...
<?php $__env->stopSection(); ?><?php /**PATH D:\8.4 php\htdocs\jamipol\resources\views/admin/vms_ifream/edit_return.blade.php ENDPATH**/ ?>