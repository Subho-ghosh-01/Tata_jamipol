...
<?php $__env->startSection('content'); ?>
                                    ...
                                    <tr
                                        ...
                                        <td>
                                            <?php if($gatepass->created_datetime >= '2024-03-27'): ?>
                                                ...
                                                <button type="button" <?php echo e($dd ?? ''); ?> class="btn btn-danger btn-sm exit-emp-btn"
    ...
    <script>
        ...
        $(document).on('click', '.update-btn', function () {
            ...
            const month = parseInt($('#monthSelect').val());
            const year = parseInt($('#yearSelect').val());
            var path = "<?php echo e(route('admin.updateAttendance')); ?>/" + day + "/" + newStatus + "/" + empPno + "/" + month + "/" + year;
