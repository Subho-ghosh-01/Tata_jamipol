...
<?php $__env->startSection('breadcrumbs'); ?>
    ...
    <li class="breadcrumb-item"><a href="<?php echo e(route('admin.approve_clms.index')); ?>">List Of Contractor's GatePass</a></li>
...
<?php $__env->startSection('content'); ?>
    ...
    <?php if(Session::get('clm_role') == 'Shift_incharge' || Session::get('clm_role') == 'hr_dept' || Session::get('clm_role') == 'Safety_dept' || Session::get('clm_role') == 'plant_head' || Session::get('clm_role') == 'Executing_agency'): ?>
    ...
    <?php else: ?>
        <ul class="nav nav-tabs" id="myTab" role="tablist">
            <li class="nav-item">
                <a class="nav-link active" id="home-tab" data-toggle="tab" href="#home" role="tab" aria-controls="home"
                    aria-selected="true"><?php if(Session::get('clm_role') == 'security'): ?>
                        Gatepass Approved
                    <?php elseif(Session::get('user_sub_typeSession') == 3): ?>
                        ALL Gatepass
                    <?php else: ?> My Gatepass
                    <?php endif; ?></a>
            </li>
            <?php if(Session::get('clm_role') != 'security'): ?>
                <li class="nav-item">
                    <a class="nav-link " id="home-tab" data-toggle="tab" href="#home1" role="tab" aria-controls="home"
                        aria-selected="true">
                        <?php if(Session::get('user_sub_typeSession') == 3): ?> Approved/Rejected
                        <?php else: ?>
                            Rejected Gatepass
                        <?php endif; ?>
                    </a>
                            ...
                            <?php if($gatepasss->count() > 0): ?>
                                ...
                                <?php $__currentLoopData = $gatepasss; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $gatepass): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <?php
                                        ...
                                        if ($gatepass->return_status === 'Pending_exit' && $gatepass->status === 'Pending_for_security') {
                                    ...
                                    <tr
                                        style="<?php echo e($gatepass->return_status == 'Pending_exit' ? 'background-color: #f8d7da;' : ''); ?>">

                                        <td><?php echo e($count++); ?></td>
                                        <td><?php echo e($gatepass->full_sl); ?></td>
                                        <td><?php echo e(@$approver->name); ?></td>
                                        <td><?php echo e($gatepass->name); ?></td>
                                        <td><?php echo e($gatepass->work_order_no); ?></td>
                                        <td><?php if($gatepass->status == "Pending_for_shift_incharge"): ?>
                                            <?php echo e("Pending From Shift Incharge"); ?>

                                        <?php elseif($gatepass->status == "Pending_for_hr"): ?>
                                                <?php echo e("Pending From HR Dept"); ?>

                                            <?php elseif($gatepass->status == "Pending_for_safety"): ?>
                                                <?php echo e("Pending From Safety Dept"); ?>

                                            <?php elseif($gatepass->status == "Pending_for_plant_head"): ?>
                                                <?php echo e("Pending From Plant Head"); ?>

                                            <?php elseif($gatepass->status == "Pending_for_security"): ?>
                                                <?php echo e("Gatepass Approved"); ?>

                                            <?php elseif($gatepass->status == "Pending_executing"): ?>
                                                <?php echo e("Pending For Executing Department"); ?>
                                        ...
                                        <td>
                                            <?php if($gatepass->created_datetime >= '2024-03-27'): ?>
                                                <h5 style="color:red"><?php echo e($pp ?? ''); ?></h5>
                                                <a class="btn btn-info btn-sm"
                                                    href="<?php echo e(route('admin.edit_clms_new.edit', \Crypt::encrypt($gatepass->id))); ?>"
                                                    title="Edit">Details </a>
                                                <button type="button" <?php echo $dd; ?> class="btn btn-danger btn-sm exit-emp-btn"
                                                    data-id="<?php echo e(@$gatepass->id); ?>" data-bs-toggle="modal"
                                            ...
                                            <?php else: ?>
                                                <a class="btn btn-info btn-sm"
                                                    href="<?php echo e(route('admin.edit_clms.edit', \Crypt::encrypt($gatepass->id))); ?>"
                                                    title="Edit">Details</a>
                                            <?php endif; ?>
                                            <?php if($gatepass->status == "Pending_for_security" && ($gatepass->created_by == Session::get('user_idSession') or Session::get('user_idSession') == '6')): ?>
                                                <a class="btn btn-info btn-sm"
                                                    href="<?php echo e(route('admin.renew_clms.edit', \Crypt::encrypt($gatepass->id))); ?>"
                                                    title="Edit" <?php echo e($dd ?? ''); ?>>Renew</a>
                                            <?php endif; ?>
                                            <?php if($gatepass->status == "Pending_for_security" && (Session::get('clm_role') == 'security' || Session::get('vms_role') == 'Security')): ?>
                                                <a class="btn btn-info btn-sm"
                                                    href="<?php echo e(route('admin.printg_clms.printg', \Crypt::encrypt($gatepass->id))); ?>"
                                                    title="Edit" target="_blank">Print</a>
                                            <?php endif; ?>

                                            <!-- Button trigger modal -->
                                            <?php if((Session::get('clm_role') == 'hr_dept' || Session::get('user_sub_typeSession') == 3) && $gatepass->status == "Pending_for_security"): ?>
                                                <button type="button" class="btn btn-primary btn-sm" data-bs-toggle="modal"
                                                    data-emp_pno="<?php echo e(@$gatepass->emp_pno); ?>" data-emp_name="<?php echo e(@$gatepass->name); ?>"
                    ...
                    <table class="table table-striped table-sm" id="my-permit1">
                        ...
                        <tbody>
                            <?php if($gatepassss->count() > 0): ?>
                                <?php    $count = 1;?>
                                <?php $__currentLoopData = $gatepassss; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $gatepasss): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <tr>
                                        <td><?php echo e($count++); ?></td>
                                        <td><?php echo e($gatepasss->full_sl); ?></td>
                                        <td><?php echo e(@$approver->name); ?></td>
                                        <td><?php echo e($gatepasss->name); ?></td>
                                        <td><?php echo e($gatepasss->work_order_no); ?></td>
                                        <td><?php if($gatepasss->status == "Pending_for_shift_incharge"): ?>
                                            <?php echo e("Pending From  Shift Incharge"); ?>

                                        <?php elseif($gatepasss->status == "Pending_for_hr"): ?>
                                                <?php echo e("Pending From HR Dept"); ?>

                                            <?php elseif($gatepasss->status == "Pending_for_safety"): ?>
                                                <?php echo e("Pending From Safety Dept"); ?>

                                            <?php elseif($gatepasss->status == "Pending_for_plant_head"): ?>
                                                <?php echo e("Pending From Plant Head"); ?>

                                            <?php elseif($gatepasss->status == "Pending_for_security"): ?>
                                                <?php echo e("Gatepass Approved"); ?>

                                            <?php elseif($gatepasss->status == "Rejected"): ?>
                                                <?php echo e("Rejected"); ?>
                                        ...
                                        <td>
                                            ...
                                            <?php if($gatepasss->status == "Pending_for_security" && $gatepasss->created_by == Session::get('user_idSession')): ?>
                                                <a class="btn btn-info btn-sm"
                                                    href="<?php echo e(route('admin.renew_clms.edit', \Crypt::encrypt($gatepasss->id))); ?>"
                                                    title="Edit">Renew</a>
                                            <?php endif; ?>
                                            <?php if($gatepasss->created_datetime >= '2024-03-27'): ?>
                                                <a class="btn btn-info btn-sm"
                                                    href="<?php echo e(route('admin.edit_clms_new.edit', \Crypt::encrypt($gatepasss->id))); ?>"
                                                    title="Edit">Details </a>
                                            <?php else: ?>
                                                <a class="btn btn-info btn-sm"
                                                    href="<?php echo e(route('admin.edit_clms.edit', \Crypt::encrypt($gatepasss->id))); ?>"
                                                    title="Edit">Details</a>
                                            <?php endif; ?>
                                            <?php if($gatepasss->status == "Pending_for_security" && (Session::get('clm_role') == 'security' || Session::get('vms_role') == 'Security')): ?>
                                                <a class="btn btn-info btn-sm"
                                                    href="<?php echo e(route('admin.printg.printg', \Crypt::encrypt($gatepasss->id))); ?>"
                                                    title="Edit">Print</a>
                                            <?php endif; ?>
                                            <?php if(Session::get('clm_role') == 'hr_dept' && $gatepasss->status == "Pending_for_security"): ?>
                                                <button type="button" class="btn btn-primary btn-sm" data-bs-toggle="modal"
                                                    data-emp_pno="<?php echo e(@$gatepasss->emp_pno); ?>" data-emp_name="<?php echo e(@$gatepasss->name); ?>"
                                                    data-bs-target="#myModal" id="attendance">
                                                    Check Attendance
                                                </button>
                                            <?php endif; ?>
            ...
            <div class="tab-pane fade " id="home2" role="tabpanel" aria-labelledby="home2-tab">
                <div class="table-responsive">
                    <table class="table table-striped table-sm" id="my-permit2">
                        ...
                        <tbody>
                            <?php if($gatepassss_exit->count() > 0): ?>
                                <?php    $count = 1;?>
                                <?php $__currentLoopData = $gatepassss_exit; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $gatepasss_exit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php
                                    ...
                                    <tr>
                                        <td><?php echo e($count++); ?></td>
                                        <td><?php echo e($gatepasss_exit->full_sl ?? '-'); ?></td>
                                        <td><?php echo e($gatepasss_exit->name ?? '-'); ?></td>
                                        <td><?php echo e($approver->name ?? '-'); ?></td> 

                                        <td>
                                            <?php if($gatepasss_exit->return_status == 'Pending_exit'): ?>
                                                <p style="color: red;">Exit Processing...</p>
                                            <?php elseif($gatepasss_exit->return_status == 'completed_exit'): ?>
                                                <p style="color:green;">Completed</p>
                                            <?php endif; ?>
                                        </td>
                                        <td>
                                            <a class="btn btn-info btn-sm"
                                                href="<?php echo e(route('admin.exit_emp_details.edit', \Crypt::encrypt($gatepasss_exit->id))); ?>"
            ...
            <div class="tab-pane fade " id="home3" role="tabpanel" aria-labelledby="home3-tab">
                <div class="table-responsive">
                    ...
                    <table class="table table-striped table-sm" id="my-permit3">
                        ...
                        <tbody>
                            <?php if($gatepasss_shift->count() > 0): ?>
                                <?php    $count = 1;?>
                                <?php $__currentLoopData = $gatepasss_shift; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $gatepass_shift): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php
                                    ...
                                    <tr>
                                        <td>
                                            <input type="checkbox" class="form-check-input row-checkbox" name="selected_ids[]"
                                                value="<?php echo e($gatepass_shift->id); ?>">
                                        </td>
                                        <td><?php echo e($count++); ?></td>
                                        <td><?php echo e($gatepass_shift->full_sl ?? '-'); ?></td>
                                        <td><?php echo e($gatepass_shift->emp_pno ?? '-'); ?></td>
                                        <td><?php echo e($gatepass_shift->name ?? '-'); ?></td>
                                        <td><?php echo e($approver->name ?? '-'); ?></td> 

                                        <td>
                                            <?php echo e($gatepass_shift->shift ?? '-'); ?>
            ...
            <div class="modal-content">
                        ...
                        <select id="monthSelect" class="form-select form-select-sm d-inline-block w-auto">
                            <?php for($m = 1; $m <= date('m'); $m++): ?>
                                <option value="<?php echo e($m); ?>" <?php echo e($m == date('n') ? 'selected' : ''); ?>>
                                    <?php echo e(date('F', mktime(0, 0, 0, $m, 10))); ?>
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3 p-1 border rounded bg-light shadow-sm small fw-bold text-dark">
                        <strong class="d-block mb-2 text-uppercase" style="font-size: 7px;">📘 Nomenclature of Symbols:</strong>
                        ...
                        <span class="text-primary">NH</span> = National Holiday,&nbsp;
                        <span class="text-primary">Holiday</span> = Holiday,&nbsp;
                        <span class="text-primary">OT</span> = Over Time,&nbsp;
    ...
    <script>
        function generateCalendar(month, year, user_id) {
            ...
            var path = "<?php echo e(route('admin.getMonthlyAttendance')); ?>/" + user_id + '/' + month + '/' + year
                        ...
                        for (let day = 0; day < 7; day++) {
                            if ((week === 0 && day < startDay) || dayCounter > daysInMonth) {
                                ...
                                html += `<td style="${tdStyle}">
                                                                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                                                                    <option value="NH" ${status === 'NH' ? 'selected' : ''}>NH</option>
                                                                                                                                                                                                                                                                                                    <option value="FLP" ${status === 'FLP' ? 'selected' : ''}>Holiday</option>
                                                                                                                                                                                                                                                                                                    <option value="SPL" ${status === 'SPL' ? 'selected' : ''}>SPL</option>
                                                                                                                                                                                                                                                                                                    <option value="dayoff" ${status === 'dayoff' ? 'selected' : ''}>OFF</option>
                                                                                                                                                                                                                                                                                                    <option value="OT" ${status === 'OT' ? 'selected' : ''}>OT</option>
                                                                                                                                                                                                                                                                                                     <option hidden value="Missed Pun" ${status === 'Missed Pun' ? 'selected' : ''} ${ishidden}>MP</option>
                                                                                                                                                                                                                                                                                                </select>
                                                                                                                                                                                                                                                                                                <div class="ot-hours-input d-none" style="margin-top: 5px;">
                                                                                                                                                                                                                                                                                                    <input type="number" class="form-control form-control-sm ot-hours"  placeholder="Hours (max 2)" min="0.5" max="2" step="0.5" style="font-size: 10px;">
                                                                                                                                                                                                                                                                                                    <small class="text-muted" style="font-size: 8px;">Max 2 hours</small>
                                                                                                                                                                                                                                                                                                </div>
        ...
        $(document).on('change', '.attendance-select', function () {
            ...
            // Show/hide OT hours input
            if (newStatus === 'OT') {
                $parentTd.find('.ot-hours-input').removeClass('d-none');
                $parentTd.find('.update-btn').addClass('d-none'); // Hide until hours entered
                return; // Don't proceed with AJAX validation yet
            } else {
                $parentTd.find('.ot-hours-input').addClass('d-none');
                $parentTd.find('.ot-hours').val(''); // Clear hours value
            }

            var path = "<?php echo e(route('admin.updateAttendance_check')); ?>/" + day + "/" + newStatus + "/" + empPno + "/" + month + "/" + year;
        ...
        $(document).on('click', '.update-btn', function () {
            ...
            // Get OT hours if OT is selected
            let otHours = '';
            if (newStatus === 'OT') {
                otHours = $parentTd.find('.ot-hours').val();
            }

            var path = "<?php echo e(route('admin.updateAttendance')); ?>/" + day + "/" + newStatus + "/" + empPno + "/" + month + "/" + year + "/" + otHours;
        ...
        // Handle OT hours input validation
        $(document).on('input', '.ot-hours', function () {
            const $parentTd = $(this).closest('td');
            const hours = parseFloat($(this).val());

            if (hours >= 0.5 && hours <= 2) {
                $parentTd.find('.update-btn').removeClass('d-none');
                $parentTd.find('.attendance-message').html('');
            } else {
                $parentTd.find('.update-btn').addClass('d-none');
                if (hours > 2) {
                    $parentTd.find('.attendance-message').html('Max 2 hours allowed');
                } else if (hours < 0.5 && hours > 0) {
                    $parentTd.find('.attendance-message').html('Min 0.5 hours required');
                }
            }
        });
...
<?php $__env->startSection('scripts'); ?>
    ...
    <script type="text/javascript">
        ...
        $("#exit_emp").on("click", function () {
            ...
            var path = "<?php echo e(route('admin.exit_emp')); ?>/" + id + '/' + message_remarks
            $("#loaderOverlay").show();
            $.ajax({
                url: path,
                type: "GET",
    ...
    <script type="text/javascript">
        $("#updateEmployeeBtn").on("click", function () {
            ...
            $.ajax({
                url: "<?php echo e(route('admin.update_empid_bulk')); ?>",
                type: "POST",
                data: {
                    _token: "<?php echo e(csrf_token()); ?>",
                    ids: ids,
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\8.4 php\htdocs\jamipol\resources\views/admin/gatepass_approvals/approve_clms.blade.php ENDPATH**/ ?>