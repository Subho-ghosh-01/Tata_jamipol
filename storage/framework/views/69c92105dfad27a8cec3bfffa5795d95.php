<?php if($data['send_to'] == 'Vendor_to_safety'): ?>
    <!DOCTYPE html>
    <html>
    ...
    <body style="font-family: Arial, sans-serif; color: #333333; padding: 20px; background-color: #f9f9f9;">
        ...
        <div
            ...
            <p style="margin-top: 25px; line-height: 1.6;">
                Thanking you,<br><br>
                Best regards,<br>
                <strong><?php echo e($data['vendor_name']); ?></strong><br>
...
<?php elseif($data['send_to'] == 'Emp_to_safety'): ?>
    <!DOCTYPE html>
    <html>
    ...
    <body style="font-family: Arial, sans-serif; color: #333333; padding: 20px; background-color: #f9f9f9;">
        ...
        <div
            ...
            <p style="margin-top: 25px; line-height: 1.6;">
                ...
                Best regards,<br>
                <strong><?php echo e($data['vendor_name']); ?></strong><br>
                <strong><?php echo e($data['vendor_code']); ?></strong>
            </p>
...
<?php elseif($data['send_to'] == 'Safety_to_emp_approve'): ?>
    <!DOCTYPE html>
    <html>
        ...
        <div
            ...
            <div style="background-color: #f1f1f1; padding: 10px 15px; border-radius: 5px; margin: 10px 0;">
                ...
                <p style="margin: 6px 0;"><strong style="display: inline-block; width: 150px;">Vendor Code:</strong>
                    <?php echo e($data['vendor_code']); ?></p>
                <p style="margin: 6px 0;"><strong style="display: inline-block; width: 150px;">Vehicle Number:</strong>
                    <?php echo e($data['vehicle_registration_no']); ?></p>
                <p style="margin: 6px 0;"><strong style="display: inline-block; width: 180px;">Type of Vehicle:</strong>
                    <?php if(strtolower($data['vehicle_type']) == 'two_wheeler'): ?>
                        Two Wheeler
                    <?php elseif(strtolower($data['vehicle_type']) == 'four_wheeler'): ?>
                        Car
                    <?php else: ?>
                        <?php echo e($data['vehicle_type']); ?>
...
<?php elseif($data['send_to'] == 'Safety_to_vendor_approve'): ?>
        ...
        <div
            ...
            <div style="background-color: #f1f1f1; padding: 10px 15px; border-radius: 5px; margin: 10px 0;">
                ...
                <p style="margin: 6px 0;"><strong style="display: inline-block; width: 180px;">Driver/Pass Holder
                        Name:</strong> <?php echo e($data['driver_name']); ?></p>
                <p style="margin: 6px 0;"><strong style="display: inline-block; width: 180px;">Vehicle Number:</strong>
                    <?php echo e($data['vehicle_registration_no']); ?></p>
                <p style="margin: 6px 0;"><strong style="display: inline-block; width: 180px;">Type of Vehicle:</strong>
                    <?php if(strtolower($data['vehicle_type']) == 'two_wheeler' || strtolower($data['vehicle_type']) == 'two_wheelr'): ?>
                        Two Wheeler
                    <?php elseif(strtolower($data['vehicle_type']) == 'four_wheeler' || strtolower($data['vehicle_type']) == 'car'): ?>
                        Car
                    <?php else: ?>
                        <?php echo e($data['vehicle_type']); ?>
...
<?php elseif($data['send_to'] == 'Emp_to_safety_surander'): ?>
    <!DOCTYPE html>
    <html>
    ...
    <body style="font-family: Arial, sans-serif; color: #333333; padding: 20px; background-color: #f9f9f9;">
        ...
        <div
            ...
            <div style="font-size: 18px; font-weight: bold; color: #a94442; margin-bottom: 20px;">
                Vehicle Entry Pass Surrender – <?php echo e($data['vendor_name']); ?> | <?php echo e($data['vehicle_registration_no']); ?>
            ...
            <p style="margin: 10px 0; line-height: 1.6;">
                ...
                bearing number
                <strong><?php echo e($data['vehicle_registration_no']); ?></strong>.
            </p>
            ...
            <p style="margin-top: 25px; line-height: 1.6;">
                ...
                <strong><?php echo e($data['vendor_name']); ?></strong><br>
                <strong><?php echo e($data['department']); ?></strong>
            </p>
...
<?php elseif($data['send_to'] == 'vendor_to_safety_surander'): ?>
    <!DOCTYPE html>
    <html>
    ...
    <body style="font-family: Arial, sans-serif; color: #333333; padding: 20px; background-color: #f9f9f9;">
        ...
        <div
            ...
            <!-- Main Message -->
            <p style="margin: 10px 0; line-height: 1.6;">
                This is to inform you that the vehicle pass issued to our employee <?php echo e($data['employee_name']); ?> is being
                surrendered, as
            ...
            <div style="background-color: #f1f1f1; padding: 10px 15px; border-radius: 5px; margin: 15px 0;">
                ...
                <p style="margin: 6px 0;"><strong style="display: inline-block; width: 170px;">Driver Name:</strong>
                    <?php echo e($data['driver_name']); ?></p>
                <p style="margin: 6px 0;"><strong style="display: inline-block; width: 170px;">Vehicle Number:</strong>
                    <?php echo e($data['vehicle_registration_no']); ?></p>
                <p style="margin: 6px 0;"><strong style="display: inline-block; width: 170px;">Reason for
                        Surrender:</strong> <?php echo e($data['reason']); ?></p>
                <p style="margin: 6px 0;"><strong style="display: inline-block; width: 170px;">Date of Surrender:</strong>
                    <?php echo e(date('d-m-Y', strtotime($data['surrender_date']))); ?></p>
            </div>
...
<?php elseif($data['send_to'] == 'Safety_to_emp_surrendor'): ?>
    <!DOCTYPE html>
    <html>
    ...
    <body
        ...
        <div style="background-color: #fff; border: 1px solid #ddd; padding: 25px; border-radius: 4px;">
            ...
            <p style="margin-bottom: 15px;">
                ...
                number <strong><?php echo e($data['vehicle_registration_no']); ?></strong> has been successfully processed.
            </p>

            <p style="margin-bottom: 15px;">
                We confirm that the <strong>physical vehicle pass has been received</strong> by the Safety Department on
                <strong><?php echo e($data['surrender_date']); ?></strong>, and your pass has now been deactivated in our system.
            </p>
            ...
            <div style="margin: 20px 0; padding: 15px; background-color: #f9f9f9; border-left: 4px solid #d9534f;">
                ...
                <ul style="margin: 0; padding-left: 20px;">
                    <li style="margin-bottom: 5px;"><strong>Employee Name:</strong> <?php echo e($data['vendor_name']); ?></li>
                    <li style="margin-bottom: 5px;"><strong>Department:</strong> <?php echo e($data['department']); ?></li>
                    <li style="margin-bottom: 5px;"><strong>Vehicle Number:</strong> <?php echo e($data['vehicle_registration_no']); ?>

                    </li>
                    <li><strong>Date of Surrender:</strong> <?php echo e($data['surrender_date']); ?></li>
                </ul>
            </div>
...
<?php elseif($data['send_to'] == 'Safety_to_vendor_surrendor'): ?>
    <!DOCTYPE html>
    <html>
        ...
        <div style="background-color: #fff; border: 1px solid #ddd; padding: 25px; border-radius: 4px;">
            ...
            <div style="margin-bottom: 20px;">
                ...
                <div style="font-size: 14px; color: #666; margin-top: 5px;">
                    <?php echo e($data['vehicle_registration_no']); ?> | <?php echo e($data['vendor_name']); ?>
            ...
            <p style="margin-bottom: 15px;">
                ...
                <strong><?php echo e($data['vendor_name']); ?></strong> for the vehicle bearing registration number
                <strong><?php echo e($data['vehicle_registration_no']); ?></strong>.
            </p>

            <p style="margin-bottom: 15px;">
                We confirm that the <strong>physical pass has been received</strong> at our end on
                <strong><?php echo e($data['surrender_date']); ?></strong>, and the corresponding vehicle entry pass has been marked as
            ...
            <div style="margin: 20px 0; padding: 15px; background-color: #f9f9f9; border-left: 4px solid #d9534f;">
                ...
                <ul style="margin: 0; padding-left: 20px;">
                    <li style="margin-bottom: 5px;"><strong>Vendor Organization:</strong> <?php echo e($data['vendor_name']); ?></li>
                    <li style="margin-bottom: 5px;"><strong>Driver/Pass Holder Name:</strong> <?php echo e($data['driver_name']); ?></li>
                    <li style="margin-bottom: 5px;"><strong>Vehicle Number:</strong> <?php echo e($data['vehicle_registration_no']); ?>

                    </li>
                    <li style="margin-bottom: 5px;"><strong>Reason for Surrender:</strong> <?php echo e($data['reason']); ?></li>
                    <li><strong>Date of Surrender:</strong> <?php echo e($data['surrender_date']); ?></li>
                </ul>
            </div>
...
<?php endif; ?><?php /**PATH D:\8.4 php\htdocs\jamipol\resources\views/admin/vms_ifream/send_mail.blade.php ENDPATH**/ ?>