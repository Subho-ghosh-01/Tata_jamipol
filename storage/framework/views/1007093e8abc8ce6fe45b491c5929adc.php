        ...
        <div class="login-card">
            <div class="row g-0">
                ...
                <div class="col-md-6 brand-section">
                    ...
                    <img src="<?php echo e(asset('images/top_logo.png')); ?>" alt="Security">
                </div>
                ...
                <div class="col-md-6 form-section">
                        ...
                        <div class="mb-3">
                            ...
                            <?php if($errors->has('vendor_code')): ?>
                                <?php $__currentLoopData = $errors->get('vendor_code'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $error): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="text-danger mt-1 small"><?php echo e($error); ?></div>
                    ...
                    <div class="text-center mt-4">
                        <a href="<?php echo e(URL::to('forgotPage')); ?>" class="me-3">
                            <i class="fas fa-key me-1"></i>Forgot Password?
                        </a>
                        <a href="<?php echo e(URL::to('RegisterGatepass')); ?>">
...
<?php /**PATH D:\8.4 php\htdocs\jamipol\resources\views/loginPage.blade.php ENDPATH**/ ?>