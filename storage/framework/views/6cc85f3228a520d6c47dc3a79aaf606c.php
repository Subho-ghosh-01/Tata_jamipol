...
<?php $__env->startSection('content'); ?>
	...
	<div class="card card-primary">
		...
		<div class="card-body">
			<table class="table table-bordered ">
				...
				<tr>
					<th>Visitor Name</th>
					<td class="col-7"><?php echo e(@$gatepassv->visitor_name); ?></td>
				</tr>
				<tr>
					<th>Visitor Mobile No</th>
					<td><?php echo e(@$gatepassv->visitor_mobile_no); ?> </td>
				</tr>
				<tr>
					<th>Visitor Company</th>
					<td><?php echo e(@$gatepassv->visitor_company); ?></td>
				</tr>

				<tr>
					<th>Visitor Email</th>
					<td><?php echo e(@$gatepassv->visitor_email); ?></td>
				</tr>
				<tr>
					<th>Visitor Emergency Contact No</th>
					<td><?php echo e(@$gatepassv->visitor_emergency_contact_no); ?> </td>
				</tr>
				<tr>
					<th>Proof of Identity</th>
					<td><?php echo e(@$gatepassv->id_proof_type ?? ''); ?></td>
				</tr>
				<tr>
					<th>Unique Identification Number</th>
					<td><?php echo e(@$gatepassv->id_number ?? ''); ?></td>
				</tr>
				<tr>
					<th>Division</th>
					<td> <?php echo e(@$division_p->name); ?></td>
				</tr>
				...
				<tr>
					<th>Days</th>
					<td><?php echo e(@$gatepassv->days); ?></td>
				</tr>
				<tr>
					<th>From Date</th>
					<td><?php echo e(date('d-m-Y', strtotime(@$gatepassv->from_date))); ?></td>
				</tr>
				<tr>
					<th>To Date</th>
					<td><?php echo e(date('d-m-Y', strtotime(@$gatepassv->to_date))); ?></td>
				</tr>
				<tr>
					<th>From Time </th>
					<td><?php echo e(date('h:i:s A', strtotime(@$gatepassv->from_time))); ?></td>
				</tr>
				<tr>
					<th>To Time </th>
					<td><?php echo e(date('h:i:s A', strtotime(@$gatepassv->to_time))); ?></td>
				</tr>
				<tr>
					<th>Any material/equipment/laptop carried along? </th>
					<td><?php echo e(@$gatepassv->any_material); ?></td>
				</tr>
				<tr>
					<th>Is Visitor Coming by any vehicle?
					</th>
					<td><?php echo e(@$gatepassv->visitor_any_vehicle); ?></td>
				</tr>
	...
	//dd($safety_question);
		...
		<?php if(@$gatepassv->approver_decision == 'approve'): ?>
			<div class="card-body">
				<table class="table table-bordered ">
					<tr>
					...
					<tr>
						...
						<td class="col-7"><?php echo e(@$gatepassv->approver_remarks); ?></td>
					</tr>
					<tr>
						<th>Approved Date</th>
						<td class="col-7"><?php echo e(date('d-m-Y ', strtotime(@$gatepassv->approver_datetime))); ?></td>
					</tr>
			</div>

		<?php elseif(@$gatepassv->approver_decision == 'reject'): ?>
		...
		<?php if(@$gatepassv->status == 'Completed'): ?>
			<div class="card-body">
				...
				<table class="table table-bordered table-hover table-condensed">
					...
					<form class="form-horizontal" method="POST" autocomplete="off"
						action="<?php echo e(route('admin.gatepassv.update_security')); ?>">
						<?php echo csrf_field(); ?>

						<tr>
							<th>Returned By</th>
							<td class="col-7"><?php echo e($approver_security->name); ?> </td>

						</tr>

						<tr>
							<th>Returned Remarks</th>
							<td class="col-7"> <?php echo e($gatepassv->security_print_remarks); ?></td>

						</tr>
						<tr>
							<th>Returned Datetime</th>
							<td class="col-7"> <?php echo e(date('d-m-Y H:i:s', strtotime(@$gatepassv->security_print_datetime))); ?> </td>
		...
		<?php if(@$gatepassv->status == 'Pending_to_approve' && @$gatepassv->approver == Session::get('user_idSession')): ?>
			<br>
			<div class="card-body">
				...
				<form class="form-horizontal" method="POST" autocomplete="off" action="<?php echo e(route('admin.gatepassv.update_vms')); ?>">
					<?php echo csrf_field(); ?>
		...
		<?php if((Session::get('vms_role') == 'Security' && @$gatepassv->status == 'issued') || (Session::get('vms_role') == 'Approver' && @$gatepassv->status == 'issued')): ?>
			<div class="card-body">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\8.4 php\htdocs\jamipol\resources\views/admin/gatepass_approvals/edit.blade.php ENDPATH**/ ?>