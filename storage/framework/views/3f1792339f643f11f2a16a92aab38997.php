            ...
            <div class="tab-pane fade show active" id="basic" role="tabpanel">
                ...
                <div class="row col-12">
                    <div class="form-group col-6">
                        ...
                        <input type="number" class="form-control" name="work_order_no" value="<?php echo e($vms->work_order_no); ?>"
                            disabled>
                    </div>
                    <div class="form-group col-6">
                        <label>Validity <span class="text-danger">*</span></label>
                        <input type="date" class="form-control" name="validity" value="<?php echo e($vms->validity); ?>" disabled>
                    </div>
                    <div class="form-group col-6">
            ...
            <div class="tab-pane fade" id="lead" role="tabpanel">
                ...
                <div class="form-group col-12">
                    ...
                    <input type="text" class="form-control" name="vehicle_reg_no"
                        value="<?php echo e($vms->vehicle_registration_no); ?>" disabled>
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="date" class="form-control" name="insurance_from" value="<?php echo e($vms->insurance_from); ?>"
                            disabled>
                    </div>
                    <div class="col-md-6 mb-3">
                        <label>Insurance To <span class="text-danger">*</span></label>
                        <input type="date" class="form-control" name="insurance_to" value="<?php echo e($vms->insurance_to); ?>"
                            disabled>
                    </div>
 ...
 <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <input type="date" class="form-control" name="valid_fitness_inspection_date"
                        value="<?php echo e($vms->valid_fitness_inspection_date); ?>" disabled>
...
<div class="col-md-6 mb-3"><label>Valid Fitness Inspection Due Date <span class="text-danger">*</span></label>
                    <input type="date" class="form-control" name="valid_fitness_inspection_due_date"
                        value="<?php echo e($vms->vehicle_fitness_due_date); ?>" disabled>                
                    </div>
                ...
                <div class="row">
                    <div class="col-md-6 mb-3 p-3">
                        ...
                        <input type="date" class="form-control" name="road_permit_from"
                            value="<?php echo e($vms->valid_road_permit_date); ?>" disabled>
                    </div>
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="date" class="form-control" name="road_permit_due"
                            value="<?php echo e($vms->valid_road_permit_due_date); ?>" disabled>
                    </div>
            ...
            <div class="tab-pane fade" id="lag" role="tabpanel">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" name="vehicle_deputed_for" disabled>
                        ...
                        <option value="Local Movement" <?php echo e($vms->vehicle_dupted_for == 'Local Movement' ? 'selected' : ''); ?>>
                            Local Movement</option>
                        <option value="To Other States" <?php echo e($vms->vehicle_dupted_for == 'To Other States' ? 'selected' : ''); ?>>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" name="dfms_available" disabled>
                        <option value="">Select</option>
                        <option value="Yes" <?php echo e($vms->dfms == 'Yes' ? 'selected' : ''); ?>>Yes</option>
                        <option value="No" <?php echo e($vms->dfms == 'No' ? 'selected' : ''); ?>>No</option>
                    </select>
                </div>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" name="gps_tracker_available" disabled>
                        <option value="">Select</option>
                        <option value="Yes" <?php echo e($vms->gps_tracker == 'Yes' ? 'selected' : ''); ?>>Yes</option>
                        <option value="No" <?php echo e($vms->gps_tracker == 'No' ? 'selected' : ''); ?>>No</option>
                    </select>
                </div>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" name="hatch_strainers" disabled>
                        <option value="">Select</option>
                        <option value="Yes" <?php echo e($vms->hatch_strainers == 'Yes' ? 'selected' : ''); ?>>Yes</option>
                        <option value="No" <?php echo e($vms->hatch_strainers == 'No' ? 'selected' : ''); ?>>No</option>
                    </select>
                </div>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" name="fuel_tank_strainers" disabled>
                        <option value="">Select</option>
                        <option value="Yes" <?php echo e($vms->fuel_tank_strainers == 'Yes' ? 'selected' : ''); ?>>Yes</option>
                        <option value="No" <?php echo e($vms->fuel_tank_strainers == 'No' ? 'selected' : ''); ?>>No</option>
                    </select>
                </div>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" name="battery_placement" disabled>
                        <option value="">Select</option>
                        <option value="Yes" <?php echo e($vms->battery_placment == 'Yes' ? 'selected' : ''); ?>>Yes</option>
                        <option value="No" <?php echo e($vms->battery_placment == 'No' ? 'selected' : ''); ?>>No</option>
                    </select>
                </div>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" name="fire_extinguisher" disabled>
                        <option value="">Select</option>
                        <option value="Yes" <?php echo e($vms->fire_extinguishers == 'Yes' ? 'selected' : ''); ?>>Yes</option>
                        <option value="No" <?php echo e($vms->fire_extinguishers == 'No' ? 'selected' : ''); ?>>No</option>
                    </select>
                </div>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" name="first_aid_box" disabled>
                        <option value="">Select</option>
                        <option value="Yes" <?php echo e($vms->first_aid_box == 'Yes' ? 'selected' : ''); ?>>Yes</option>
                        <option value="No" <?php echo e($vms->first_aid_box == 'No' ? 'selected' : ''); ?>>No</option>
                    </select>
                </div>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" name="stepney" disabled>
                        <option value="">Select</option>
                        <option value="Yes" <?php echo e($vms->stepney == 'Yes' ? 'selected' : ''); ?>>Yes</option>
                        <option value="No" <?php echo e($vms->stepney == 'No' ? 'selected' : ''); ?>>No</option>
                    </select>
                </div>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" name="scotch_blocks" disabled>
                        <option value="">Select</option>
                        <option value="Yes" <?php echo e($vms->scoth_block == 'Yes' ? 'selected' : ''); ?>>Yes</option>
                        <option value="No" <?php echo e($vms->scoth_block == 'No' ? 'selected' : ''); ?>>No</option>
                    </select>
                </div>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" name="earth_chain" disabled>
                        <option value="">Select</option>
                        <option value="Yes" <?php echo e($vms->earth_chain == 'Yes' ? 'selected' : ''); ?>>Yes</option>
                        <option value="No" <?php echo e($vms->earth_chain == 'No' ? 'selected' : ''); ?>>No</option>
                    </select>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="date" class="form-control" name="pressure_vessel_test_date"
                            value="<?php echo e($vms->vessel_test_date); ?>" disabled>
                    </div>
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="date" class="form-control" name="pressure_vessel_due_date"
                            value="<?php echo e($vms->vessel_due_date); ?>" disabled>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="date" class="form-control" name="pressure_gauge_date"
                            value="<?php echo e($vms->pressure_gauge_date); ?>" disabled>
                    </div>
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="date" class="form-control" name="pressure_gauge_due_date"
                            value="<?php echo e($vms->pressure_gauge_due_date); ?>" disabled>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="date" class="form-control" name="pressure_relief_test_date"
                            value="<?php echo e($vms->pressure_relief_test_date); ?>" disabled>
                    </div>
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="date" class="form-control" name="pressure_relief_due_date"
                            value="<?php echo e($vms->pressure_relief_due_date); ?>" disabled>
                    </div>
        ...
        <?php if($vms->status == 'return' && $vms->created_by == $user_id): ?>
            <div class=" text-center mt-4">
                <button type="submit" class="btn btn-primary px-5 py-2 rounded-pill shadow-sm" style="font-size: 1.1rem;">
                    <i class="fas fa-edit me-2"></i>
                    <a href="<?php echo e(route('vendor_silo.edit', $vms->id)); ?>" target="_blank" style="color:white"> Click here to
                        edit your
                        details
                    </a></button>
            </div>
...
<?php $__empty_1 = true; $__currentLoopData = $VendorMisFlows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $vms1): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
    <fieldset class="border p-3 mb-3 rounded">
        ...
        <div class="card-body material-card mt-4 shadow rounded-3">
            ...
            <?php if($vms1->schedule_date != '1900-01-01' && !empty($vms1->schedule_date)): ?>
           <div class="row mb-4">
                <div class="col-md-12">
                    <label class="form-label fw-semibold">📝 Schedule Date</label>
                    <input type="date" class="form-control"
                        value="<?php echo e(ucfirst(@$vms1->schedule_date ?? 'Edited/Corrected  by Vendor')); ?>" disabled>
                </div>
...
<?php if(($user_check_safety->clm_role == 'Safety_dept' && @$flow->department_id == '2') || ($vms->approver_id == $user_id && $vms->status == 'pending_with_inclusion_user') || ($user_check_safety->silo_role == 'operation_dept' && @$flow->department_id == '3') ): ?>
    <fieldset class="border p-3 mb-3 rounded">
        <legend class="float-none w-auto px-2 fs-6 fw-bold text-success">Tanker Inclusion</legend>
...
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
    ...
    <?php if(($user_check_safety->clm_role == 'Safety_dept' && @$flow->department_id == '2') || ($vms->approver_id == $user_id && $vms->return_status == 'pending_with_inclusion_user')): ?>
        <fieldset class="border p-3 mb-3 rounded">
            <legend class="float-none w-auto px-2 fs-6 fw-bold text-danger">Tanker Exclusion</legend>
            <div class="card-body material-card mt-4 shadow rounded-3" <?php if(@$flow->id): ?> <?php echo e(''); ?><?php else: ?><?php echo e('hidden'); ?><?php endif; ?>>
    ...
    <script>
        ...
        document.getElementById('hr_form').addEventListener('submit', function (e) {
            ...
            fetch('<?php echo e(route("vendor_silo.update", $vms_details->id)); ?>', {
    ...
    </script><?php /**PATH D:\8.4 php\htdocs\jamipol\resources\views/admin/vendor_silo/edit_data_ifream.blade.php ENDPATH**/ ?>