...
<form action="<?php echo e(route('admin.division.update',$division->id)); ?>" method="post"  autocomplete="off">
    <?php echo csrf_field(); ?>
    ...
    <div class="form-group row">
        <label for="form-control-label" class="col-sm-2 col-form-label">Name</label>
        <div class="col-sm-10">
            <input type="text" class="form-control" name="abbreviation" id="" value="<?php echo e($division->abbreviation); ?>">
        </div>
    </div>
...
<?php $__env->stopSection(); ?>
<?php endif; ?>
<?php echo $__env->make('admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\8.4 php\htdocs\jamipol\resources\views/admin/divisions/edit.blade.php ENDPATH**/ ?>