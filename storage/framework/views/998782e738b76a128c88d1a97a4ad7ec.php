...
<?php $__env->startSection('content'); ?>
    <div class="container py-5">
        ...
        <div class="row justify-content-right">
            ...
            <form class="form-inline" autocomplete="off" action="<?php echo e(route('admin.daily_attendence_view')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                ...
                <div class="form-group mx-sm-2 mb-2">
                    <a href="<?php echo e(route('admin.daily_attendence_view')); ?>" class="btn btn-info d-block text-start"
                ...
                <div class="form-group mb-2">
                    <a href="<?php echo e(route('admin.daily_attendence_upload')); ?>" class="btn btn-success d-block text-start"
                        style="max-width: fit-content;">
                    ...
                    <tbody>
                        ...
                        <?php $__empty_1 = true; $__currentLoopData = $attendanceLogs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            ...
                            <tr>
                                ...
                                <td><?php echo e($pnoStats[$row->PNo]->total_days ?? 0); ?></td>
                                <td>₹<?php echo e($pnouser->skill_rate ?? 0); ?></td>
                                <td><?php echo e(number_format($extra_hours, 2)); ?></td>
                                <td>₹<?php echo e(number_format($basic_plus_da, 2) ?? 0); ?></td>
                                <td>₹<?php echo e(number_format($pf, 2)); ?></td>
                                <td>₹<?php echo e(number_format($esic, 2)); ?></td>
                                <td>₹<?php echo e(number_format($net, 2)); ?></td>
                                <td>₹<?php echo e(number_format($Bonus, 2)); ?> </td>
                            </tr>
...
<?php $__env->stopSection(); ?>
            ...
            <?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\8.4 php\htdocs\jamipol\resources\views/admin/gatepass_approvals/daily_attendence_view.blade.php ENDPATH**/ ?>