...
<?php else: ?>
    <iframe id="myIframe" src="<?php echo e(route('vms_ifream.edit_return', [$vms->id, $user_id])); ?>"
        style="border: none; overflow: hidden;" width="101%" width="100%" height="500" scrolling="yes"></iframe>
    <center>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\8.4 php\htdocs\jamipol\resources\views/admin/vms/edit_return.blade.php ENDPATH**/ ?>