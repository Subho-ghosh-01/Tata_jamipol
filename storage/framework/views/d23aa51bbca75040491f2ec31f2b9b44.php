...
<?php else: ?>
    <iframe id="myIframe" src="<?php echo e(route('vendor_mis.edit_data_ifream', $vms->id)); ?>" style="border: none; overflow: hidden;"
    ...
    <script>
        ...
        window.addEventListener('message', function (e) {
            if (e.data === 'iframeLoaded') {
                ...
                // Adjust height
                try {
                    iframe.style.height = iframe.contentWindow.document.body.scrollHeight + '1px';
                } catch (e) {
