...
<?php $__env->startSection('content'); ?>
    ...
    <?php else: ?>
        ...
        <iframe id="myIframe" src="<?php echo e(route('vendor_mis.edit_data_ifream', [$vms->id, $user_id])); ?>"
        ...
        <style>
            .classic-10 {
                ...
                color: #0000;
                text-shadow:
                    calc(0*var(--w)) 0 #000, calc(-1*var(--w)) 0 #000, calc(-2*var(--w)) 0 #000,
            ...
            @keyframes c10 {
                9.09% {
                    text-shadow: calc(0*var(--w)) -10px #000, calc(-1*var(--w)) 0 #000, calc(-2*var(--w)) 0 #000, calc(-3*var(--w)) 0 #000;
                }

                18.18% {
                    text-shadow: calc(0*var(--w)) 0 #000, calc(-1*var(--w)) -10px #000, calc(-2*var(--w)) 0 #000, calc(-3*var(--w)) 0 #000;
                }

                27.27% {
                    text-shadow: calc(0*var(--w)) 0 #000, calc(-1*var(--w)) 0 #000, calc(-2*var(--w)) -10px #000, calc(-3*var(--w)) 0 #000;
                }

                36.36% {
                    text-shadow: calc(0*var(--w)) 0 #000, calc(-1*var(--w)) 0 #000, calc(-2*var(--w)) 0 #000, calc(-3*var(--w)) -10px #000;
                }

                /* remaining frames omitted for brevity */
            }
        </style>
    <?php endif; ?>
<?php $__env->stopSection(); ?>
...
<?php echo $__env->make('admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\8.4 php\htdocs\jamipol\resources\views/admin/vendor_mis/edit_entry.blade.php ENDPATH**/ ?>