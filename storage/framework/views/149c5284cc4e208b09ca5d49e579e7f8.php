...
<div class="content">
        ...
        <h1 class="h3" ><?php echo e(@$gatepassv->full_sl); ?></h1>
                            ...
                            <table id="example1" class="table table-bordered ">
                                <thead>
                                    ...
                                    <button class="btn"><i class="fa fa-download"></i> Download File</button> </a></td>-->
                                        ...
                                        <td>  <a href="https://wps.jamipol.com/documents/clm_pics/<?php echo e($gatepassv->upload_id_proof); ?>" target="_blank">
                                    <button class="btn"><i class="fa fa-download"></i> View File</button> </a></td>
										</tr>
										<tr>
                                        <th>Identity Proof Photo Back </th>
                           
                                        <td>  <a href="https://wps.jamipol.com/documents/clm_pics/<?php echo e($gatepassv->upload_id_proof_back); ?>" target="_blank">
                                    <button class="btn"><i class="fa fa-download"></i> View File</button> </a></td>
										</tr>
										<tr>
                                        <th>Education</th>
                                        ...
                                        <td>  <a href="https://wps.jamipol.com/documents/clm_pics/<?php echo e($gatepassv->upload_result); ?>" target="_blank">
                                    <button class="btn"><i class="fa fa-download"></i> View File</button> </a></td>
										</tr>
										<?php endif; ?>
										<tr>
                                        ...
                                        <td> <a href="https://wps.jamipol.com/documents/clm_pics/<?php echo e($gatepassv->upload_pf_copy); ?>" target="_blank">
                                    <button class="btn"><i class="fa fa-download"></i> View File</button> </a></td>
										</tr>
										<tr>
                                        <th>ESIC</th>
                                        ...
                                        <td> <a href="https://wps.jamipol.com/documents/clm_pics/<?php echo e($gatepassv->esic_document); ?>" target="_blank">
                                    <button class="btn"><i class="fa fa-download"></i> View File</button> </a></td>
										</tr>
									         <tr>
                                        <th>Blood Group</th>
                                        ...
                                        <td>  <a href="https://wps.jamipol.com/documents/clm_pics/<?php echo e($gatepassv->upload_fittenss_copy); ?>" target="_blank">
     <button class="btn"><i class="fa fa-download"></i> View File</button>
									...
									<?php if($gatepassv->police_verification_copy !=''): ?>	
                                        ...
                                        <td>  <a href="https://wps.jamipol.com/documents/clm_pics/<?php echo e($gatepassv->police_verification_copy); ?>" target="_blank">
     <button class="btn"><i class="fa fa-download"></i> View File</button>
 </a></td>
										</tr>
...
<tr>
										...
										<tr>
                                        <th>Passport Copy</th>
                                        <td>  <a href="https://wps.jamipol.com/documents/clm_pics/<?php echo e($gatepassv->passport_copy); ?>" target="_blank">
     <button class="btn"><i class="fa fa-download"></i> View File</button>
 </a></td>
										</tr>
<?php endif; ?>
                                        ...
                                        <td> 
                                        	...
                                        	<a href="https://wps.jamipol.com/documents/clm_pics/<?php echo e($gatepassv->upload_photo); ?>" target="_blank">
     <button class="btn"><i class="fa fa-download"></i> View File</button>
 </a></td>
										</tr>
										<tr>
...
<div class="card card-primary">
						<div class="card card-primary card text-white bg-primary mb-1">
                           ...
                           <h5 style="text-white"> Executing Agency </h5>
                            ...
                            <div class="card-body">
                            <form class="form-horizontal" role="form" method="POST" autocomplete="off" id="" action="<?php echo e(route('admin.gatepassv.update1')); ?>">
                            	 <?php echo csrf_field(); ?>
                           ...
                           <label >Reject</label></td>
									...
									<th class="col-4">
                                               Remarks
												...
												<td>
										<input type="hidden" class="form-control rec" name="id" id="" autocomplete="off"  value="<?php echo e($gatepassv->id); ?>">
...
<?php if(@$gatepassv->pending_excueting_by!=''): ?>
<div class="card card-primary">
						<div class="card card-primary card text-white bg-primary mb-1">
                           ...
                           <h5 style="text-white"> Executing Agency (<?php echo e(ucfirst(@$shift->name)); ?>)  </h5>
                            ...
                            <form class="form-horizontal" role="form" method="POST" autocomplete="off" id="" action="<?php echo e(route('admin.gatepassv.update1')); ?>">
                             ...
                             <table class="table table-bordered table-hover table-condensed">
										 ...
										 <td><input type="text" class="form-control" readonly name="" id="" autocomplete="off"  value="<?php echo e(ucfirst(@$gatepassv->pending_excuting_decision)); ?>">
                           </td>
									...
									<th class="col-4">
                                      Executing Agency Remarks
										...
										<input type="hidden" class="form-control rec" name="id" id="" autocomplete="off"  value="<?php echo e($gatepassv->id); ?>">
									<!--	<input type="text" class="form-control"  name="remarks" id="remarks1" placeholder="Dept Head Remarks" required>-->
										  	<input type="text" class="form-control rec" value="<?php echo e(@$gatepassv->pending_excuting_remarks); ?>" autocomplete="off"  readonly>
										</td>
                                         </tr>
									...
									<th class="col-4">
										...
										<input type="hidden" class="form-control rec" name="id" id="" autocomplete="off"  value="<?php echo e($gatepassv->id); ?>">
									<!--	<input type="text" class="form-control"  name="remarks" id="remarks1" placeholder="Dept Head Remarks" required>-->
										  	<input type="text" class="form-control rec" value="<?php echo e(date('d-F-Y H:i:s A', strtotime(@$gatepassv->pending_eccuting_date))); ?>" autocomplete="off"  readonly>
										</td>
                                         </tr>
							</table>
...
@$shift = UserLogin::where('id',@$gatepassv->safety_training_by)->first();
 ?>
                           <h5 style="text-white"> Schedule of Safety Induction Training   (<?php echo e(ucfirst(@$shift->name)); ?>)  </h5>
                             ...
                             <table class="table table-bordered table-hover table-condensed">
									...
									<th class="col-4">
                                      Training Date
										...
										<input type="hidden" class="form-control rec" name="id" id="" autocomplete="off"  value="<?php echo e($gatepassv->id); ?>">
									<!--	<input type="text" class="form-control"  name="remarks" id="remarks1" placeholder="Dept Head Remarks" required>-->
										  	<input type="text" class="form-control rec"  value="<?php echo e(date('d-F-Y', strtotime(@$gatepassv->safety_training_date))); ?>"  autocomplete="off"  readonly>
										</td>
                                         </tr>
<tr>
									<th class="col-4">
                                      Training Time
										  	...
										  	<input type="text" class="form-control rec"  value="<?php echo e(date('H:i:s', strtotime(@$gatepassv->safety_training_time))); ?>"  autocomplete="off"  readonly>
										</td>
                                         </tr>
...
<tr>
									<th class="col-4">
                                      Safety Induction Number
										...
										<input type="hidden" class="form-control rec" name="id" id="" autocomplete="off"  value="<?php echo e($gatepassv->id); ?>">
									<!--	<input type="text" class="form-control"  name="remarks" id="remarks1" placeholder="Dept Head Remarks" required>-->
										  	<input type="text" class="form-control rec" value="<?php echo e(@$gatepassv->safety_pass_no); ?>" autocomplete="off"  readonly>
										</td>
                                         </tr>
										 ...
										 <td><input type="text" class="form-control" readonly name="" id="" autocomplete="off"  value="<?php echo e(ucfirst(@$gatepassv->safety_decision)); ?>">
                           </td>
									...
									<th class="col-4">
                                      Safety Remarks
										...
										<input type="hidden" class="form-control rec" name="id" id="" autocomplete="off"  value="<?php echo e($gatepassv->id); ?>">
									<!--	<input type="text" class="form-control"  name="remarks" id="remarks1" placeholder="Dept Head Remarks" required>-->
										  	<input type="text" class="form-control rec" value="<?php echo e(@$gatepassv->safety_remarks); ?>" autocomplete="off"  readonly>
										</td>
                                         </tr>
									...
									<th class="col-4">
										...
										<input type="hidden" class="form-control rec" name="id" id="" autocomplete="off"  value="<?php echo e($gatepassv->id); ?>">
									<!--	<input type="text" class="form-control"  name="remarks" id="remarks1" placeholder="Dept Head Remarks" required>-->
										  	<input type="text" class="form-control rec" value="<?php echo e(date('d-F-Y H:i:s A', strtotime(@$gatepassv->safety_datetime))); ?>" autocomplete="off"  readonly>
										</td>
                                         </tr>
							</table>
                           ...
                           <h5 style="text-white"> HR Dept (<?php echo e(ucfirst(@$shift->name)); ?>)  </h5>
                            ...
                            <form class="form-horizontal" role="form" method="POST" autocomplete="off" id="" action="<?php echo e(route('admin.gatepassv.update1')); ?>">
                             ...
                             <table class="table table-bordered table-hover table-condensed">
										 ...
										 <td><input type="text" class="form-control" readonly name="" id="" autocomplete="off"  value="<?php echo e(ucfirst(@$gatepassv->hr_decision)); ?>">
                           </td>
									...
									<th class="col-4">
										...
										<input type="hidden" class="form-control rec" name="id" id="" autocomplete="off"  value="<?php echo e($gatepassv->id); ?>">
									<!--	<input type="text" class="form-control"  name="remarks" id="remarks1" placeholder="Dept Head Remarks" required>-->
										  	<input type="text" class="form-control rec" value="<?php echo e(@$gatepassv->hr_remarks); ?>" autocomplete="off"  readonly>
										</td>
                                         </tr>
									...
									<th class="col-4">
										...
										<input type="hidden" class="form-control rec" name="id" id="" autocomplete="off"  value="<?php echo e($gatepassv->id); ?>">
									<!--	<input type="text" class="form-control"  name="remarks" id="remarks1" placeholder="Dept Head Remarks" required>-->
										  	<input type="text" class="form-control rec" value="<?php echo e(date('d-F-Y H:i:s A', strtotime(@$gatepassv->hr_datetime))); ?>" autocomplete="off"  readonly>
										</td>
                                         </tr>
							</table>
                           ...
                           <h5 style="text-white"> Shift In Charge (<?php echo e(ucfirst(@$shift->name)); ?>)  </h5>
                            ...
                            <form class="form-horizontal" role="form" method="POST" autocomplete="off" id="" action="<?php echo e(route('admin.gatepassv.update1')); ?>">
                             ...
                             <table class="table table-bordered table-hover table-condensed">
										 ...
										 <td><input type="text" class="form-control" readonly name="" id="" autocomplete="off"  value="<?php echo e(ucfirst(@$gatepassv->shift_incharge_decision)); ?>">
                           </td>
									...
									<th class="col-4">
										...
										<input type="hidden" class="form-control rec" name="id" id="" autocomplete="off"  value="<?php echo e($gatepassv->id); ?>">
									<!--	<input type="text" class="form-control"  name="remarks" id="remarks1" placeholder="Dept Head Remarks" required>-->
										  	<input type="text" class="form-control rec" value="<?php echo e(@$gatepassv->shift_incharge_remarks); ?>" autocomplete="off"  readonly>
										</td>
                                         </tr>
									...
									<th class="col-4">
										...
										<input type="hidden" class="form-control rec" name="id" id="" autocomplete="off"  value="<?php echo e($gatepassv->id); ?>">
									<!--	<input type="text" class="form-control"  name="remarks" id="remarks1" placeholder="Dept Head Remarks" required>-->
										  	<input type="text" class="form-control rec" value="<?php echo e(date('d-F-Y H:i:s A', strtotime(@$gatepassv->shift_incharge_datetime))); ?>" autocomplete="off"  readonly>
										</td>
                                         </tr>
							</table>
                           ...
                           <h5 style="text-white"> Plant Head (<?php echo e(ucfirst(@$shift->name)); ?>)  </h5>
                            ...
                            <form class="form-horizontal" role="form" method="POST" autocomplete="off" id="" action="<?php echo e(route('admin.gatepassv.update1')); ?>">
                             ...
                             <table class="table table-bordered table-hover table-condensed">
										 ...
										 <td><input type="text" class="form-control" readonly name="" id="" autocomplete="off"  value="<?php echo e(ucfirst(@$gatepassv->plant_head_decision)); ?>">
                           </td>
                                    ...
                                    Plant Head Remarks
										...
										<input type="hidden" class="form-control rec" name="id" id="" autocomplete="off"  value="<?php echo e($gatepassv->id); ?>">
									<!--	<input type="text" class="form-control"  name="remarks" id="remarks1" placeholder="Dept Head Remarks" required>-->
										  	<input type="text" class="form-control rec" value="<?php echo e(@$gatepassv->plant_head_remarks); ?>" autocomplete="off"  readonly>
										</td>
                                         </tr>
									...
									<th class="col-4">
                                       Plant Head Remarks Datetime
										...
										<input type="hidden" class="form-control rec" name="id" id="" autocomplete="off"  value="<?php echo e($gatepassv->id); ?>">
									<!--	<input type="text" class="form-control"  name="remarks" id="remarks1" placeholder="Dept Head Remarks" required>-->
										  	<input type="text" class="form-control rec" value="<?php echo e(date('d-F-Y H:i:s A', strtotime(@$gatepassv->plant_head_datetime))); ?>" autocomplete="off"  readonly>
										</td>
                                         </tr>
							</table>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\8.4 php\htdocs\jamipol\resources\views/admin/gatepass_approvals/edit_clms.blade.php ENDPATH**/ ?>