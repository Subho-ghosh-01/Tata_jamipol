                ...
                <select class="form-control" name="vendor_id" id="vendor_id">
                    ...
                    <?php if($vendors->count() > 0): ?>
                        <?php $__currentLoopData = $vendors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $vendor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($vendor->id); ?>" <?php if($vendor->id == Session::get('user_idSession')): ?> <?php echo e('selected'); ?><?php endif; ?>>
                        ...
                        <?php $__currentLoopData = $report; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $reports): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <tr>
                                ...
                                <td><a class="btn btn-info btn-sm"
                                        href="<?php echo e(route('admin.edit_clms.edit', \Crypt::encrypt($reports->id))); ?>" title="Edit">Details</a>
