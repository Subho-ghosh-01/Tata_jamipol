...
<?php $__env->startSection('breadcrumbs'); ?>
    ...
    <li class="breadcrumb-item"><a href="<?php echo e(route('admin.vendor_esic_details.index')); ?>">List of Safety Performance System</a>
    </li>
...
<?php else: ?>
    ...
    <?php $__env->startSection('content'); ?>
        ...
        <iframe id="myIframe" src="<?php echo e(url('vendor_mis/create_ifream/' . $id)); ?>"
            style="border: none; width: 101%; height: 90%; overflow: auto; margin-right: -17px;">
        </iframe>
