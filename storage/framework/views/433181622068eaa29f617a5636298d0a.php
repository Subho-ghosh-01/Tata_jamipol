<?php if($data['send_to'] == 'Vendor_full_document'): ?>
                    ...
                    <table width="600" cellpadding="0" cellspacing="0" border="0"
                        ...
                        <tr>
                            <td style="padding:20px; font-family:Arial, sans-serif; font-size:15px; color:#333333;">
                                <p style="margin-top:0;">Dear <?php echo e($data['name']); ?>,</p>

                                <p>You have initiated an exit request for the following employee:</p>

                                <p><strong>Employee Name:</strong> <?php echo e($data['employee_name']); ?></p>
...
<?php elseif($data['send_to'] == 'Vendor_request_executing'): ?>
...
<?php elseif($data['send_to'] == 'Vendor_full_document_hr'): ?>
...
<?php endif; ?><?php /**PATH D:\8.4 php\htdocs\jamipol\resources\views/admin/gatepass_approvals/send_mail_emp.blade.php ENDPATH**/ ?>