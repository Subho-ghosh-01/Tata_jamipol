...
<?php $__env->startSection('breadcrumbs'); ?>
    ...
    <li class="breadcrumb-item"><a href="<?php echo e(route('admin.vendor_esic_details.index')); ?>">List of Vendor Bonus Return /
            Filling Documents</a>
    </li>
    <li class="breadcrumb-item active" aria-current="page">Vendor Bonus Return / Filling</li>
...
<?php else: ?>
    <?php $__env->startSection('content'); ?>
        ...
        <div class="col-md-12 mb-4">
            <h3 class="fw-bold">
                <i class="fas fa-eye" style="color: #43a02c;"></i> View Bonus Return / Filling
            </h3>
            ...
            <div class="row g-3">
                ...
                <div class="col-md-4">
                    ...
                    <div class="custom-file-upload text-center p-4 border rounded shadow-sm h-100 bg-light">
                        <h5 class="text-primary fw-bold mb-3">Form C</h5>

                        <?php
                            $filePath = $vendor_attendance->form_c;
                        ...
                        <i class="fas <?php echo e($icon); ?> fa-2x mb-1"></i>
                ...
                <div class="col-md-4">
                    <div class="custom-file-upload text-center p-4 border rounded shadow-sm h-100 bg-light">
                        <h5 class="text-primary fw-bold mb-3">Form D</h5>
                        <?php
                            $filePath = $vendor_attendance->form_d;
                            $ext = strtolower(pathinfo($filePath, PATHINFO_EXTENSION));
                            $fileName = basename($filePath);
                            $fullPath = asset($filePath);
                            $icon = match (true) {
        ...
        <?php if(($vendor_attendance->status == 'Pending_with_hr' && Session::get('clm_role') == 'hr_dept')): ?>
            <div class="card-body material-card mt-4 shadow rounded-3" <?php echo $foemview ?? ''; ?>>

                <form action="<?php echo e(route('admin.vendor_ecm.update', $vendor_attendance->id)); ?>" method="POST" autocomplete="off"
                    id="hr_form">
                    <?php echo csrf_field(); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\8.4 php\htdocs\jamipol\resources\views/admin/vendor_ecm/edit.blade.php ENDPATH**/ ?>