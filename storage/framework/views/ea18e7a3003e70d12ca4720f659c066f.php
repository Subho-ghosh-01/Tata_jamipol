...
<form action="" method="post" enctype="multipart/form-data" id="form_return" autocomplete="off">
    ...
    <div class="container mt-4 pb-4">
        ...
        <div class="row g-3 mt-12">
            ...
            <div class="col-md-12">
                ...
                <input type="date" class="future-date form-control hd" value="<?php echo e($vms->insurance_valid_to); ?>" name="insurance_to">
    ...
    <div class="col-md-6">
        ...
        <input type="date" class="form-control hd future-date" value="<?php echo e($vms->registraction_to); ?>" name="registration_date_to">
    </div>
</div>
        ...
        <div class="row g-3 mt-2">
            ...
            <div class="col-md-12">
                ...
                <input type="date" class="form-control hd future-date" value="<?php echo e($vms->puc_valid_to); ?>" name="puc_to">
            </div>
        ...
        <div class="row g-3 mt-2">
            ...
            <div class="col-md-12">
                ...
                <input type="date" class="form-control hd future-date" value="<?php echo e($vms->license_valid_to); ?>" name="license_valid_to">
            </div>
            <div class="col-md-12 dn">
        ...
        <div class="text-center mt-4 dn "<?php echo e($hide); ?>>
...
<script>
    ...
    document.getElementById('hr_form').addEventListener('submit', function (e) {
        ...
        fetch('<?php echo e(route("vms_ifream.update", $vms_details->id)); ?>', {
...
<?php $__env->stopSection(); ?><?php /**PATH D:\8.4 php\htdocs\jamipol\resources\views/admin/vms_ifream/edit.blade.php ENDPATH**/ ?>