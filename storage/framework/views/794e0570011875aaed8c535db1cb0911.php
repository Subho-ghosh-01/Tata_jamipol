...
<?php else: ?>
    <iframe id="myIframe" src="<?php echo e(route('vms_ifream.edit_driver_details', [$vms->id, $user_id])); ?>"
    ...
    <script>
        ...
        window.addEventListener('message', function (e) {
            if (e.data === 'iframeLoaded') {
                ...
                // Adjust height
                try {
                    iframe.style.height = '1800px'; // fallback
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\8.4 php\htdocs\jamipol\resources\views/admin/vms/edit_driver_details.blade.php ENDPATH**/ ?>