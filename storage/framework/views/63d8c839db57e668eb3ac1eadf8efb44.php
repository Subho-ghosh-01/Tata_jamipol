    ...
    <?php $__env->startSection('content'); ?>
        ...
        <?php if(($vendor_attendance->status == 'Pending_with_hr' && Session::get('clm_role') == 'hr_dept')): ?>
            <div class="card-body material-card mt-4 shadow rounded-3" <?php echo $foemview ?? ''; ?>>
                ...
                <form action="<?php echo e(route('admin.vendor_esic_details.update', $vendor_attendance->id)); ?>" method="POST"
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\8.4 php\htdocs\jamipol\resources\views/admin/vendor_esic_challan/edit.blade.php ENDPATH**/ ?>