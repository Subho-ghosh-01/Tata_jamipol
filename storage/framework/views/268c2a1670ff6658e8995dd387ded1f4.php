...
<?php $__env->startSection('breadcrumbs'); ?>
    ...
    <li class="breadcrumb-item active" aria-current="page">Upload PF Documents</li>
...
<?php else: ?>
    ...
    <?php $__env->startSection('content'); ?>
        ...
        <?php if(session('message')): ?>
            <div class="alert <?php echo e(session('message') == 'PF uploaded successfully.' ? 'alert-success' : 'alert-danger'); ?>">
        ...
        <form action="<?php echo e(route('admin.vendor_pf_details.store')); ?>" method="post" enctype="multipart/form-data" id="form"
            autocomplete="off">
            <?php echo csrf_field(); ?>
            ...
            <div class="col-md-12 mb-4">
                <h3 class="fw-bold">
                    <i class="fas fa-upload" style="color: #2c62a0;"></i> Vendor PF Challan & ECR
                </h3>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="custom-file-upload text-center" id="uploadArea1">
                            <h5 class="text-primary fw-bold mb-3 p-2">PF Challan</h5>
                    ...
                    <div class="col-md-6">
                        <div class="custom-file-upload text-center" id="uploadArea2">
                            <h5 class="text-primary fw-bold mb-3 p-2">ECR</h5>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\8.4 php\htdocs\jamipol\resources\views/admin/vendor_pf_challan/create.blade.php ENDPATH**/ ?>