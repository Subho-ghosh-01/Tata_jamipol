                ...
                <table width="600" cellpadding="0" cellspacing="0"
                    ...
                    <tr>
                        <td style="padding: 32px 40px; color: #333333;">
                            <p style="margin: 0 0 20px; font-size: 16px;">Hi <strong><?php echo e($data['name']); ?></strong>,</p>
                    ...
                    <tr>
                        <td
                            ...
                            &copy; <?php echo e(date('Y')); ?> Jamipol Limited. All rights reserved.
                        </td>
                    </tr>
...
</html><?php /**PATH D:\8.4 php\htdocs\jamipol\resources\views/send_otp.blade.php ENDPATH**/ ?>