    ...
    <script>
        ...
        function loadTable(filters = {}) {
            ...
            table = $('#Table').DataTable({
                ...
                serverSide: false,
                ajax: {
                    url: "<?php echo e(route('admin.vms.filterJson')); ?>",
                    type: 'POST',
                    data: {
        ...
        $(document).ready(function () {
            ...
            $('#exportExcel').click(function () {
                ...
                $.post("<?php echo e(route('admin.vms.filterJson')); ?>", { _token: "<?php echo e(csrf_token()); ?>", ...filters }, function (response) {
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\8.4 php\htdocs\jamipol\resources\views/admin/vms/vms_report.blade.php ENDPATH**/ ?>