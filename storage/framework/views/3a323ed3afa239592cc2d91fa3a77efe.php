    ...
    <?php $__env->startSection('content'); ?>
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
            ...
            <div class="btn-toolbar mb-2 mb-md-0">
                <a href="<?php echo e(route('admin.vendor_hyr.create')); ?>"
        ...
        <div class="table-responsive ">
            <table class="table table-striped table-sm" id="listall">
                ...
                <tbody>
                    <?php if($hyr_lists->count() > 0): ?>
                        <?php        $count = 1; ?>
                        <?php $__currentLoopData = $hyr_lists; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $hyr_list): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <tr style="white-space: nowrap;">
                                ...
                                <td><?php echo e(date('F-Y ', strtotime($hyr_list->month))); ?></td>
                                <td><a href="../<?php echo e($hyr_list->doc1); ?>" target="_blank" class="btn btn-success btn-sm">View /
                                        Download</a>
                                </td>
                                <td><?php echo $status; ?></td>
                                <td><?php echo e(date('d-m-Y H:i:s', strtotime(@$hyr_list->created_date))); ?> </td>
                                <td>
                                    <a href="<?php echo e(route('admin.vendor_hyr.edit', \Crypt::encrypt($hyr_list->id))); ?>"
...
<?php endif; ?>
<?php echo $__env->make('admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\8.4 php\htdocs\jamipol\resources\views/admin/vendor_hyr/index.blade.php ENDPATH**/ ?>