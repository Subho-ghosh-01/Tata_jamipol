    ...
    <?php $__env->startSection('content'); ?>
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
            ...
            <div class="btn-toolbar mb-2 mb-md-0">
                <a href="<?php echo e(route('admin.division_new.create')); ?>" class="btn btn-sm btn-outline-secondary">Add Division </a>
            </div>
        </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-info btn-sm"
                                        href="<?php echo e(route('admin.division_new.edit', \Crypt::encrypt($division->id))); ?>"
                                        title="Edit">Edit</a> |
                                    <a class="btn btn-danger btn-sm" onclick="deleteRecord('<?php echo e($division->id); ?>')">Delete</a>
                                    <form id="delete-<?php echo e($division->id); ?>"
                                        action="<?php echo e(route('admin.division_new.destroy', $division->id)); ?>" method="POST"
                                        style="display: none;">
                                        <?php echo csrf_field(); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\8.4 php\htdocs\jamipol\resources\views/admin/division_new/index.blade.php ENDPATH**/ ?>