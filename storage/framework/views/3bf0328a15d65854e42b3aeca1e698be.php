...
<?php $__env->startSection('breadcrumbs'); ?>
    ...
    <li class="breadcrumb-item active" aria-current="page">Vendor Safety MIS / List</a></li>
...
<?php else: ?>
    <?php $__env->startSection('content'); ?>
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
            <h1 class="h2 mb-4">
                <i class="fas fa-truck"></i> Vendor Safety MIS / List
            </h1>

            <div class="btn-toolbar mb-2 mb-md-0">
                <a href="<?php echo e(route('vendor_mis.create', ['user_id' => $id])); ?>"
        ...
        <div class="table-responsive ">
            ...
            <table class="table table-striped table-sm" id="vms-table">
                <thead>
                    <tr>
                        <th>🔢 Sl. No</th> <!-- Numbering -->
                        <th>🏭 Vendor Name</th> <!-- Factory/Vendor -->
                        <th>🏢 Division</th> <!-- Office building for division -->
                        <th>🏷️ Department</th> <!-- Label/tag icon for department -->
                        <th>🗓️ Month</th> <!-- Calendar icon for month -->
                        <th>📌 Status</th> <!-- Pin (status indicator) -->
                        <th>⏰ Created</th> <!-- Clock for created datetime -->
                        <th>🛠️ Action</th> <!-- Wrench/tools for actions -->
...
<?php endif; ?>
<?php echo $__env->make('admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\8.4 php\htdocs\jamipol\resources\views/admin/vendor_mis/index.blade.php ENDPATH**/ ?>