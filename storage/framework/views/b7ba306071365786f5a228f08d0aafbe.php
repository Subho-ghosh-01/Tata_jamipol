...
<?php else: ?>
    ...
    <?php $__env->startSection('content'); ?>
        ...
        <?php if(session('message')): ?>
            <div
                class="alert <?php echo e(session('message') == 'Wage Register uploaded successfully.' ? 'alert-success' : 'alert-danger'); ?>">
        ...
        <form action="<?php echo e(route('admin.vendor_attendance.store')); ?>" method="post" enctype="multipart/form-data" id="form"
            autocomplete="off">
            <?php echo csrf_field(); ?>
                    ...
                    <div class="col-12 order-1 p-2">
                        <div class="custom-file-upload p-4 border rounded h-100">
                            <div class="row g-3 align-items-center">
                                ...
                                ?>
                                <div class="col-md-2 <?php echo e($style); ?>">
                                    ...
                                    <select name="vendor_id" id="vendor_id" class="form-select select2" required>
                                        ...
                                        <?php $__currentLoopData = $vendorlist; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $vendor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($vendor->id); ?>" <?php if(isset($vendorName) && $vendor->id == $vendorName->id): ?> selected <?php endif; ?>>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\8.4 php\htdocs\jamipol\resources\views/admin/vendor-attendance/create.blade.php ENDPATH**/ ?>