...
<form action="" method="post" enctype="multipart/form-data" id="form" autocomplete="off" id="form">
    ...
    <input type="hidden" value="<?php echo e($vms->id); ?>" name="vendor_mis_id">
            ...
            <div class="lead-indicators mt-4">
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control indicator-value hd" name="lead2_val" id="lead2_val" min="0"
                        value="<?php echo e($vms->lead2_val); ?>" required>
                    <label class="mt-2">Attachment</label>
                    <?php
                        $lead2Docs = json_decode($vms->lead2_doc, true); // decode JSON to array
                    ?>

                    <?php if(!empty($lead2Docs) && is_array($lead2Docs)): ?>
                        <div class="row">
                            <?php $__currentLoopData = $lead2Docs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $file): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="col-md-2 mb-2">
                                    <a href="<?php echo e(asset($file)); ?>" target="_blank" class="btn btn-sm btn-outline-primary w-100">
                                        📎 View File <?php echo e($index + 1); ?>
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control indicator-value hd" name="lead3_val" id="lead3_val" min="0"
                        value="<?php echo e($vms->lead3_val); ?>" required>
                    <label class="mt-2">Attachment</label>
                    <?php
                        $lead3Docs = json_decode($vms->lead3_doc, true); // decode JSON to array
                    ?>

                    <?php if(!empty($lead3Docs) && is_array($lead3Docs)): ?>
                        <div class="row">
                            <?php $__currentLoopData = $lead3Docs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $file): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control indicator-value hd" name="lead4_val" id="lead4_val" min="0"
                        value="<?php echo e($vms->lead4_val); ?>" required>
                    <label class="mt-2">Attachment</label>
                    <?php
                        $lead4Docs = json_decode($vms->lead4_doc, true); // decode JSON to array
                    ?>

                    <?php if(!empty($lead4Docs) && is_array($lead4Docs)): ?>
                        <div class="row">
                            <?php $__currentLoopData = $lead4Docs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $file): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="col-md-2 mb-2"> <!-- 2 files per row -->
                                    <a href="<?php echo e(asset($file)); ?>" target="_blank" class="btn btn-sm btn-outline-primary w-100">
                                        📎 View File <?php echo e($index + 1); ?>
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control indicator-value hd" name="lead5_val" id="lead5_val" min="0"
                        value="<?php echo e($vms->lead5_val); ?>" required>
                    <label class="mt-2">Attachment</label>
                    <?php
                        $lead5Docs = json_decode($vms->lead5_doc, true); // decode JSON to array
                    ?>

                    <?php if(!empty($lead5Docs) && is_array($lead5Docs)): ?>
                        <div class="row">
                            <?php $__currentLoopData = $lead5Docs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $file): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="col-md-2 mb-2"> <!-- 2 files per row -->
                                    <a href="<?php echo e(asset($file)); ?>" target="_blank" class="btn btn-sm btn-outline-primary w-100">
                                        📎 View File <?php echo e($index + 1); ?>
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control indicator-value hd" name="lead6_val" id="lead6_val" min="0"
                        value="<?php echo e($vms->lead6_val); ?>" required>
                    <label class="mt-2 ">Attachment</label>
                    <?php
                        $lead6Docs = json_decode($vms->lead6_doc, true); // decode JSON to array
                    ?>

                    <?php if(!empty($lead6Docs) && is_array($lead6Docs)): ?>
                        <div class="row">
                            <?php $__currentLoopData = $lead6Docs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $file): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="col-md-2 mb-2"> <!-- 2 files per row -->
                                    <a href="<?php echo e(asset($file)); ?>" target="_blank" class="btn btn-sm btn-outline-primary w-100">
                                        📎 View File <?php echo e($index + 1); ?>
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control indicator-value hd" name="lead7_val" id="lead7_val" min="0"
                        value="<?php echo e($vms->lead7_val); ?>" required>
                    <label class="mt-2">Attachment</label>
                    <?php
                        $lead7Docs = json_decode($vms->lead7_doc, true); // decode JSON to array
                    ?>

                    <?php if(!empty($lead7Docs) && is_array($lead7Docs)): ?>
                        <div class="row">
                            <?php $__currentLoopData = $lead7Docs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $file): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="col-md-2 mb-2"> <!-- 2 files per row -->
                                    <a href="<?php echo e(asset($file)); ?>" target="_blank" class="btn btn-sm btn-outline-primary w-100">
                                        📎 View File <?php echo e($index + 1); ?>
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control indicator-value hd" name="lead8_val" id="lead8_val" min="0"
                        value="<?php echo e($vms->lead8_val); ?>" required>
                    <label class="mt-2">Attachment</label>
                    <?php
                        $lead8Docs = json_decode($vms->lead8_doc, true); // decode JSON to array
                    ?>

                    <?php if(!empty($lead8Docs) && is_array($lead8Docs)): ?>
                        <div class="row">
                            <?php $__currentLoopData = $lead8Docs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $file): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="col-md-2 mb-2"> <!-- 2 files per row -->
                                    <a href="<?php echo e(asset($file)); ?>" target="_blank" class="btn btn-sm btn-outline-primary w-100">
                                        📎 View File <?php echo e($index + 1); ?>
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control indicator-value hd" name="lead9_val" id="lead9_val" min="0"
                        value="<?php echo e($vms->lead9_val); ?>" required>
                    <label class="mt-2">Attachment</label>
                    <?php
                        $lead9Docs = json_decode($vms->lead9_doc, true); // decode JSON to array
                    ?>

                    <?php if(!empty($lead9Docs) && is_array($lead9Docs)): ?>
                        <div class="row">
                            <?php $__currentLoopData = $lead9Docs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $file): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="col-md-2 mb-2"> <!-- 2 files per row -->
                                    <a href="<?php echo e(asset($file)); ?>" target="_blank" class="btn btn-sm btn-outline-primary w-100">
                                        📎 View File <?php echo e($index + 1); ?>
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control indicator-value hd" name="lead10_val" id="lead10_val"
                        min="0" value="<?php echo e($vms->lead10_val); ?>" required>
                    <label class="mt-2">Attachment</label>
                    <?php
                        $lead10Docs = json_decode($vms->lead10_doc, true); // decode JSON to array
                    ?>

                    <?php if(!empty($lead10Docs) && is_array($lead10Docs)): ?>
                        <div class="row">
                            <?php $__currentLoopData = $lead10Docs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $file): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="col-md-2 mb-2"> <!-- 2 files per row -->
                                    <a href="<?php echo e(asset($file)); ?>" target="_blank" class="btn btn-sm btn-outline-primary w-100">
                                        📎 View File <?php echo e($index + 1); ?>
        ...
        <div class="tab-pane fade" id="lag" role="tabpanel">
            <div class="lag-indicators mt-4">
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control indicator-value hd" name="lag1_val" id="lag1_val" min="0"
                        value="<?php echo e($vms->lag1_val); ?>" required>

                    <label class="mt-2">Attachment</label>

                    <?php $lag1Docs = json_decode($vms->lag1_doc, true); ?>
                    <?php if(!empty($lag1Docs) && is_array($lag1Docs)): ?>
                        <div class="row mb-2">
                            <?php $__currentLoopData = $lag1Docs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $file): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="col-md-2 mb-2">
                                    <a href="<?php echo e(asset($file)); ?>" target="_blank" class="btn btn-sm btn-outline-primary w-100">
                                        📎 View File <?php echo e($index + 1); ?>
            ...
            <div class="form-group">
                ...
                <input type="number" class="form-control indicator-value hd" name="lag2_val" id="lag2_val" min="0"
                    value="<?php echo e($vms->lag2_val); ?>" required>
                <label class="mt-2 ">Attachment</label>
                <?php $lag2Docs = json_decode($vms->lag2_doc, true); ?>
                <?php if(!empty($lag2Docs) && is_array($lag2Docs)): ?>
                    <div class="row mb-2">
                        <?php $__currentLoopData = $lag2Docs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $file): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="col-md-2 mb-2">
                                <a href="<?php echo e(asset($file)); ?>" target="_blank" class="btn btn-sm btn-outline-primary w-100">
                                    📎 View File <?php echo e($index + 1); ?>
            ...
            <div class="form-group">
                ...
                <input type="number" class="form-control indicator-value hd" name="lag3_val" id="lag3_val" min="0"
                    value="<?php echo e($vms->lag3_val); ?>" required>
                <label class="mt-2">Attachment</label>
                <?php $lag3Docs = json_decode($vms->lag3_doc, true); ?>
                <?php if(!empty($lag3Docs) && is_array($lag3Docs)): ?>
                    <div class="row mb-2">
                        <?php $__currentLoopData = $lag3Docs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $file): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="col-md-2 mb-2">
                                <a href="<?php echo e(asset($file)); ?>" target="_blank" class="btn btn-sm btn-outline-primary w-100">
                                    📎 View File <?php echo e($index + 1); ?>
            ...
            <div class="form-group">
                ...
                <input type="number" class="form-control indicator-value hd" name="lag4_val" id="lag4_val" min="0"
                    value="<?php echo e($vms->lag4_val); ?>" required>
                <label class="mt-2">Attachment</label>
                <?php $lag4Docs = json_decode($vms->lag4_doc, true); ?>
                <?php if(!empty($lag4Docs) && is_array($lag4Docs)): ?>
                    <div class="row mb-2">
                        <?php $__currentLoopData = $lag4Docs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $file): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="col-md-2 mb-2">
                                <a href="<?php echo e(asset($file)); ?>" target="_blank" class="btn btn-sm btn-outline-primary w-100">
                                    📎 View File <?php echo e($index + 1); ?>
            ...
            <div class="form-group">
                ...
                <input type="number" class="form-control indicator-value hd" name="lag5_val" id="lag5_val" min="0"
                    value="<?php echo e($vms->lag5_val); ?>" required>
                <label class="mt-2">Attachment</label>
                <?php $lag5Docs = json_decode($vms->lag5_doc, true); ?>
                <?php if(!empty($lag5Docs) && is_array($lag5Docs)): ?>
                    <div class="row mb-2">
                        <?php $__currentLoopData = $lag5Docs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $file): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="col-md-2 mb-2">
                                <a href="<?php echo e(asset($file)); ?>" target="_blank" class="btn btn-sm btn-outline-primary w-100">
                                    📎 View File <?php echo e($index + 1); ?>
            ...
            <?php if(!empty($vms->lag6_doc)): ?>
                <div class="form-group">
                    ...
                    <input type="number" class="form-control indicator-value" name="lag6_val" id="lag6_val" disabled
                        value="<?php echo e($vms->lag6_val ?? '0'); ?>">
                    <label class="mt-2">Attachment</label>
                    <?php $lag6Docs = json_decode($vms->lag6_doc, true); ?>
                    <?php if(!empty($lag6Docs) && is_array($lag6Docs)): ?>
                        <div class="row mb-2">
                            <?php $__currentLoopData = $lag6Docs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $file): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    ...
    <div class="card-body material-card mt-4 shadow rounded-3">
        ...
        <div class="row mb-4">
            ...
            <div class="col-md-6">
                ...
                <input type="text" class="form-control" value="<?php echo e(date('d-m-Y H:i:s', strtotime($vms1->remarks_datetime))); ?>"
                    disabled>
            </div>
        </div>
    ...
    <form id="hr_form" method="POST">
        ...
        <div class="form-group">
            ...
            <input type="number" class="form-control indicator-value" name="lag6_val" id="lag6_val"
                value="<?php echo e($vms->lag6_val); ?>">
            <label class="mt-2">Attachment</label>
            <?php if(!empty($vms->lag6_doc)): ?>
                <div class="mb-2">
                    <a href="<?php echo e(asset($vms->lag5_doc)); ?>" target="_blank" class="btn btn-sm btn-outline-primary">
                        📎 View Existing File
                    </a>
                </div>
            <?php endif; ?>
...
<script>
    ...
    document.getElementById('hr_form').addEventListener('submit', function (e) {
        ...
        fetch('<?php echo e(route("vendor_mis.update", $vms_details->id)); ?>', {
...
<script>
    document.getElementById('form').addEventListener('submit', function (e) {
        ...
        fetch('<?php echo e(route("vendor_mis.update_data")); ?>', {
            method: 'POST',
            headers: {
                'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content')
...
</script><?php /**PATH D:\8.4 php\htdocs\jamipol\resources\views/admin/vendor_mis/edit_ifream.blade.php ENDPATH**/ ?>