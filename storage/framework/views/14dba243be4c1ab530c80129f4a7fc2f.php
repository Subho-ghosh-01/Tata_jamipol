...
<?php else: ?>
    <iframe id="myIframe" src="<?php echo e(route('vendor_silo.edit_ifream', [$vms->id, $user_id])); ?>"
...
<?php echo $__env->make('admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\8.4 php\htdocs\jamipol\resources\views/admin/vendor_silo/edit.blade.php ENDPATH**/ ?>