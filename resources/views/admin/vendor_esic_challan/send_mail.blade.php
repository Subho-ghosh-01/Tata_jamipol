@if($data['send_to'] == 'Vendor_to_hr')
    ...
    <head>
        <meta charset="UTF-8" />
        <title>Vendor ESIC Notification</title>
    </head>
                    ...
                    <table width="600" cellpadding="0" cellspacing="0" border="0" bgcolor="#ffffff"
                        ...
                        <tr>
                            <td style="font-size:16px; line-height:1.5; padding-bottom: 10px;">
                                ...
                                their <strong>ESIC Challan & Contribution </strong> details to the <strong>Suraksha
                        ...
                        <tr>
                            <td style="padding:25px;">
                                ...
                                <p style="line-height:1.6; font-size:14px;">
                                    This is to inform you that your <strong>ESIC Challan & Contribution </strong> documents
                                    submitted on the
