    ...
    @section('content')
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
            ...
            <div class="btn-toolbar mb-2 mb-md-0">
                <a href="{{ route('admin.vendor_esic_details.create') }}"
        ...
        <div class="table-responsive ">
            <table class="table table-striped table-sm" id="listall">
                ...
                <tbody>
                    @if($esic_lists->count() > 0)
                        <?php        $count = 1; ?>
                        @foreach($esic_lists as $esic_list)
                            ...
                            <tr style="white-space: nowrap;">
                                ...
                                <td>{{date('F-Y ', strtotime($esic_list->month))}}</td>
                                <td><a href="../{{$esic_list->esic_challan}}" target="_blank" class="btn btn-success btn-sm">View /
                                        Download</a>
                                </td>
                                <td><a href="../{{$esic_list->esic_contribution}}" target="_blank" class="btn btn-success btn-sm">View /
                                        Download</a>
                                </td>
                                <td>{!! $status !!}</td>
                                <td>{{date('d-m-Y H:i:s', strtotime(@$esic_list->created_date))}} </td>
                                <td>
                                    <a href="{{ route('admin.vendor_esic_details.edit', \Crypt::encrypt($esic_list->id)) }}"
