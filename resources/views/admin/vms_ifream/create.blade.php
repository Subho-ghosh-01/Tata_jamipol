    ...
    <div class="container mt-4 pb-4">
        ...
        <div class="form-group">
            ...
            <select class="form-control" name="vehicle_type_required" required>
                ...
                @if($type == 'Employee')
                    <option {{$not_required ?? ''}} value="four_wheeler">🚗 Car</option>
                @endif
            </select>
        </div>
        @if($type != 'Employee')
        ...
        <div class="form-group">
            ...
            <select class="form-control" name="vehicle_category" id="vehicle_category" required>
                ...
                @if($type == 'Employee')
                    <option {{$not_required ?? ''}} value="Diesel">🛢️ Diesel</option>
                    <option {{$not_required ?? ''}} value="CNG">🧯 CNG</option>
                @endif
                <option value="EV">🔌 EV</option>
                @if($type == 'Employee')
                    <option {{$not_required ?? ''}} value="Hybrid">♻️ Hybrid</option>
                @endif
