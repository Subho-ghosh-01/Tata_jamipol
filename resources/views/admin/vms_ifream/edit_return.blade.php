...
<form action="" method="post" enctype="multipart/form-data" id="form_return" autocomplete="off">
    ...
    <div class="container mt-4 pb-4">
        ...
        <div class="mb-4">
            <h3 class="fw-bold text-dark">
                ...
                {{ $type }} Vehicle Gate Pass Management System (Surrender)
            </h3>
        ...
        <div class="row g-3">
            ...
            <div class="col-md-12">
                ...
                <a href="{{ asset($vms->vehicle_registration_doc) }}" target="_blank"
    ...
    <div class="col-md-6">
        ...
        <input type="date" class="form-control hd" value="{{ $vms->registraction_to }}" name="registration_date_to">
    </div>
</div>
...
<script>
    ...
    document.getElementById('hr_form').addEventListener('submit', function (e) {
        ...
        fetch('{{ route("vms_ifream.update_return_approval", $vms_details->id) }}', {
