            ...
            <div class="card shadow-lg border-0">
                ...
                <div class="card-body bg-light">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="input-group">
                            <select id="attendance_last_day" class="form-control col-6">
                                @for ($d = 1; $d <= 31; $d++)
                                    <option value="{{ $d }}" {{ @$setting_vendor_attendance[0]->value == $d ? 'selected' : '' }}>
                                        {{ $d }}</option>
                                @endfor
                            </select>
                            &nbsp;&nbsp;
                    ...
                    <div class="mb-4">
                        ...
                        <div class="input-group">
                            <select id="esic_last_day" class="form-control col-6">
                                @for ($d = 1; $d <= 31; $d++)
                                    <option value="{{ $d }}" {{ @$setting_vendor_esic[0]->value == $d ? 'selected' : '' }}>{{ $d }}
                                    </option>
                                @endfor
                            </select>
                             &nbsp;&nbsp;
                    ...
                    <div class="mb-4">
                        ...
                        <div class="input-group">
                            <select id="pf_last_day" class="form-control col-6">
                                @for ($d = 1; $d <= 31; $d++)
                                    <option value="{{ $d }}" {{ @$setting_vendor_pf[0]->value == $d ? 'selected' : '' }}>{{ $d }}
                                    </option>
                                @endfor
                            </select>
                             &nbsp;&nbsp;
                  ...
                  <div class="mb-4">
                        ...
                        <div class="input-group">
                            &nbsp;
                            <input type="month" name="bonus_month" id="bonus_month" class="form-control col-6" value="{{ @$setting_bonus[0]->value }}">
                             &nbsp;&nbsp;
                    ...
                    <div class="mb-4">
                        ...
                        <div class="input-group ">
                            ...
                            &nbsp;
                            <input type="month" name="half_yearly1" id="half_yearly1" class="form-control col-2" value="{{ @$setting_half_yearly1[0]->value }}">
                             &nbsp;
                             <small class="me-3 fw-bold col-1">Second Month.</small>
                             <input type="month" name="half_yearly2" id="half_yearly2" class="form-control col-2" value="{{ @$setting_half_yearly2[0]->value }}">
                             &nbsp;
...
@section('scripts')
    ...
    if (type === 'half_yearly') {
        $.ajax({
            url: "{{ route('admin.settings_master.store') }}",
            method: 'POST',
            data: {
                type_name: type,
