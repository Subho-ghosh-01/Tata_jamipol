    ...
    <div class="container mt-4 pb-4">
        ...
        <div class="lead-indicators mt-4">
            ...
            <div class="row">
                ...
                <div class="form-group col-3">
                    ...
                    <input type="month" class="form-control indicator-value" name="month" id="month" required>
                </div>
            </div>
        </div>
        ...
        <div class="lag-indicators mt-4">
            ...
            <div class="form-group">
                ...
                <input type="number" class="form-control indicator-value" name="lag6_val" id="lag6_val" min="0"
                    required>
                <label class="mt-2">Attachment</label>
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        // Attachments become required when related input has value > 0
        const indicators = document.querySelectorAll('.indicator-value');
        indicators.forEach(input => {
            input.addEventListener('input', () => {
                const base = input.id.replace(/(_count|_session|_hours|_case)/, '');
                const attachment = document.getElementById(base + '_attachment');
