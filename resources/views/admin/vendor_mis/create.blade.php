...
@section('breadcrumbs')
    ...
    <li class="breadcrumb-item"><a href="{{route('admin.vendor_esic_details.index')}}">List of Safety Performance System</a>
    </li>
...
@else
    ...
    @section('content')
        ...
        <iframe id="myIframe" src="{{ url('vendor_mis/create_ifream/' . $id) }}"
