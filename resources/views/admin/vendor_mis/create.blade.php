...
@section('breadcrumbs')
    ...
    <li class="breadcrumb-item"><a href="{{route('admin.vendor_esic_details.index')}}">List of VMS
            Documents</a>
    </li>
...
@else
    ...
    @section('content')
        <iframe id="myIframe" src="{{ url('vendor_mis/create_ifream/' . $id) }}" style="border: none; overflow: hidden;"
