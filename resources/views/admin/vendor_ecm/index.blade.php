    ...
    @section('content')
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
            ...
            <div class="btn-toolbar mb-2 mb-md-0">
                <a href="{{ route('admin.vendor_ecm.create') }}"
        ...
        <div class="table-responsive ">
            <table class="table table-striped table-sm" id="listall">
                ...
                <tbody>
                    @if($ecm_lists->count() > 0)
                        <?php        $count = 1; ?>
                        @foreach($ecm_lists as $ecm_list)
                            ...
                            <tr style="white-space: nowrap;">
                                ...
                                <td>{{date('F-Y ', strtotime($ecm_list->month))}}</td>
                                <td><a href="../{{$ecm_list->form_c}}" target="_blank" class="btn btn-success btn-sm">View /
                                        Download</a>
                                </td>
                                <td><a href="../{{$ecm_list->form_d}}" target="_blank" class="btn btn-success btn-sm">View /
                                        Download</a>
                                </td>
                                <td>{!! $status !!}</td>
                                <td>{{date('d-m-Y H:i:s', strtotime(@$ecm_list->created_date))}} </td>
                                <td>
                                    <a href="{{ route('admin.vendor_ecm.edit', \Crypt::encrypt($ecm_list->id)) }}"
