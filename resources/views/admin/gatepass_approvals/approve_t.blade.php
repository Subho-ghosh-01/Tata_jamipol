...
@if(Session::get('vms_role')!= 'Security' && Session::get('vms_role')!= 'Requester')
<ul class="nav nav-tabs" id="myTab" role="tablist">
        ...
        <li class="nav-item">
            <a class="nav-link active" id="profile-tab" data-toggle="tab" href="#profile" role="tab" aria-controls="profile" aria-selected="false">Approved/Rejected</a>
        </li>
 ...
 <ul class="nav nav-tabs" id="myTab" role="tablist">
        <li class="nav-item">
            <a class="nav-link " id="home-tab_sec" data-toggle="tab" href="#home_security" role="tab" aria-controls="home_security" aria-selected="true">Issued GatePass</a>
        </li>
        <li class="nav-item">
            <a class="nav-link active" id="profile-tab_sec" data-toggle="tab" href="#profile_security" role="tab" aria-controls="profile_security" aria-selected="false">Returned GatePass</a>
        </li>
 </ul>
 @endif
...
<ul class="nav nav-tabs" id="myTab" role="tablist">
        <li class="nav-item">
            <a class="nav-link " id="home-tab" data-toggle="tab" href="#home_requester" role="tab" aria-controls="home" aria-selected="true"> My Gatepass</a>
        </li>
        
        <li class="nav-item">
            <a class="nav-link active" id="home-tab" data-toggle="tab" href="#home_requester_returned" role="tab" aria-controls="home" aria-selected="true">Issued / Returned</a>
        </li>
 </ul>
@endif
 @if(Session::get('vms_role')!= 'Security' && Session::get('vms_role')!= 'Requester')
<form action="{{ route('admin.approve_t.index')}}" method="POST" enctype="multipart/form-data">
...
<div class="tab-content" id="myTabContent">
	...
	@if(Session::get('vms_role') == 'Security')
	<div class="tab-content" id="myTabContent">
        <div class="tab-pane fade " id="home_security" role="tabpanel" aria-labelledby="home-tab_sec">
            <div class="table-responsive">
                <table class="table table-striped table-sm" id="my-permit"> 
                    <thead>
                        <tr>
        ...
        <div class="tab-pane fade show active" id="profile_security" role="tabpanel" aria-labelledby="profile-tab_sec">
            <div class="table-responsive">
                <table class="table table-striped table-sm" id="my-permit1"> 
                    <thead>
                        <tr>
...
@if(Session::get('vms_role') == 'Requester')
<div class="tab-content" id="myTabContent">
        <div class="tab-pane fade " id="home_requester" role="tabpanel" aria-labelledby="home-tab_sec">
            <div class="table-responsive">
                <table class="table table-striped table-sm" id="my-permit"> 
                    <thead>
                        <tr>
        ...
        <div class="tab-pane fade show active" id="home_requester_returned" role="tabpanel" aria-labelledby="home-tab_sec">
            <div class="table-responsive">
                <table class="table table-striped table-sm" id="my-permit1"> 
                    <thead>
                        <tr>
