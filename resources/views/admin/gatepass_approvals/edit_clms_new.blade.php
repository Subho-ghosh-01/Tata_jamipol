					...
					<div class="flex justify-content-between">
						<div class="card card-primary">
							<div
								...
								<h1 class="h3">{{@$gatepassv->full_sl}} ({{@$gatepassv->gp_status}})</h1>
								...
								<table id="example1" class="table table-bordered ">
									<thead>
										...
										<tr>
											...
											<td>{{@$approver->lobour_license_no}}</td>
										</tr>
										<tr>
											<th>Labour License Validity</th>
											<td>{{@$approver->labour_license_validity}}</td>
										</tr>

										<tr>
											<th>Labour License Doc</th>
											<td><a href="https://wps.jamipol.com/documents/clm_pics/{{$approver->lobour_license_document}}"
													target="_blank">
										...
										<tr>
											<th>Caste</th>
											<td>{{ucfirst(@$gatepassv->caste)}}</td>
										</tr>
										<tr>
											<th>Employee Pno</th>
											<td>{{ucfirst(@$gatepassv->emp_pno)}}</td>
										</tr>
										...
										<tr>
											...
											<td> <a href="https://wps.jamipol.com/documents/clm_pics/{{$gatepassv->upload_id_proof}}"
													target="_blank">
													<button class="btn"><i class="fa fa-download"></i> View File</button>
												</a></td>
										</tr>
										<tr>
											...
											<td> <a href="https://wps.jamipol.com/documents/clm_pics/{{$gatepassv->upload_id_proof_back}}"
													target="_blank">
													<button class="btn"><i class="fa fa-download"></i> View File</button>
												</a></td>
										</tr>
										...
										@if($gatepassv->education != "Below-Matric")
											...
											<tr>
												...
												<td> <a href="https://wps.jamipol.com/documents/clm_pics/{{$gatepassv->upload_result}}"
														target="_blank">
														<button class="btn"><i class="fa fa-download"></i> View File</button>
													</a></td>
											</tr>
										...
										<tr>
											...
											<td> <a href="https://wps.jamipol.com/documents/clm_pics/{{$gatepassv->upload_pf_copy}}"
													target="_blank">
													<button class="btn"><i class="fa fa-download"></i> View File</button>
												</a></td>
										</tr>
										@if(@$gatepassv->esic_type == 'ESIC')
											...
											<tr>
												...
												<td> <a href="https://wps.jamipol.com/documents/clm_pics/{{$gatepassv->esic_document}}"
														target="_blank">
														<button class="btn"><i class="fa fa-download"></i> View File</button>
													</a></td>
											</tr>
										@elseif(@$gatepassv->esic_type == 'WCP')
											<tr>
												...
												<td> {{@$gatepassv->wcno}}</td>
											</tr>

											<tr>
												<th>Workman Compensation Validity</th>

												<td> {{date('d-F-Y', strtotime(@$gatepassv->wcv))}}</td>
											</tr>
											<tr>
												<th>Workman Compensation Document</th>

												<td> <a href="https://wps.jamipol.com/documents/clm_pics/{{@$gatepassv->wcp_doc}}"
														target="_blank">
														<button class="btn"><i class="fa fa-download"></i> View File</button>
													</a></td>
											</tr>
										...
										<tr>
											...
											<td> <a href="https://wps.jamipol.com/documents/clm_pics/{{$gatepassv->upload_fittenss_copy}}"
													target="_blank">
													<button class="btn"><i class="fa fa-download"></i> View File</button>
												</a></td>
										</tr>
										@if($gatepassv->police_verification_copy != '')
											...
											<tr>
												...
												<td> <a href="https://wps.jamipol.com/documents/clm_pics/{{$gatepassv->police_verification_copy}}"
														target="_blank">
														<button class="btn"><i class="fa fa-download"></i> View File</button>
													</a></td>
											</tr>
										...
										@if($gatepassv->passport_no != '')
											...
											<tr>
												<th>Passport Copy</th>
												<td> <a href="https://wps.jamipol.com/documents/clm_pics/{{$gatepassv->passport_copy}}"
														target="_blank">
														<button class="btn"><i class="fa fa-download"></i> View File</button>
													</a></td>
											</tr>
										...
										<tr>
											...
											<td>
												...
												<a href="https://wps.jamipol.com/documents/clm_pics/{{$gatepassv->upload_photo}}"
													target="_blank">
													<button class="btn"><i class="fa fa-download"></i> View File</button>
												</a>
											</td>
								...
								<div class="card card-primary">
									...
									<div class="card-body">
										<form class="form-horizontal" role="form" method="POST" autocomplete="off" id=""
											action="{{route('admin.gatepassv.update1')}}">
											@csrf
												...
												<tr>
													...
													<td>
														<input type="hidden" class="form-control rec" name="id" id=""
															autocomplete="off" value="{{$gatepassv->id}}">
							...
							@if(@$gatepassv->pending_excueting_by != '' && @$gatepassv->pending_eccuting_date != '')
								<div class="card card-primary">
									<div class="card card-primary card text-white bg-primary mb-1">
											...
											<table class="table table-bordered table-hover table-condensed">
												...
												<tr>
													...
													<td><input type="text" class="form-control" readonly name="" id=""
															autocomplete="off"
															value="{{ucfirst(@$gatepassv->pending_excuting_decision)}}">
													</td>
												...
												<tr>
													...
													<td>
														...
														<input type="text" class="form-control rec"
															value="{{@$gatepassv->pending_excuting_remarks}}" autocomplete="off"
															readonly>
													</td>
												</tr>
												...
												<tr>
													...
													<td>
														...
														<!--	<input type="text" class="form-control"  name="remarks" id="remarks1" placeholder="Dept Head Remarks" required>-->
														<input type="text" class="form-control rec"
															value="{{date('d-F-Y H:i:s A', strtotime(@$gatepassv->pending_eccuting_date))}}"
										...
										<form class="form-horizontal" role="form" method="POST" autocomplete="off" id=""
											...
											<table class="table table-bordered table-hover table-condensed">
												...
												<tr>
													...
													<td><input type="text" class="form-control" readonly name="" id=""
															autocomplete="off" value="{{ucfirst(@$gatepassv->hr_decision)}}">
													</td>
												...
												<tr>
													...
													<td>
														...
														<!--	<input type="text" class="form-control"  name="remarks" id="remarks1" placeholder="Dept Head Remarks" required>-->
														<input type="text" class="form-control rec"
															value="{{@$gatepassv->hr_remarks}}" autocomplete="off" readonly>
													</td>
												</tr>
												...
												<tr>
													...
													<td>
														...
														<!--	<input type="text" class="form-control"  name="remarks" id="remarks1" placeholder="Dept Head Remarks" required>-->
														<input type="text" class="form-control rec"
															value="{{date('d-F-Y H:i:s A', strtotime(@$gatepassv->hr_datetime))}}"
															autocomplete="off" readonly>
													</td>
												</tr>
											</table>
											...
											<table class="table table-bordered table-hover table-condensed">
												...
												<tr>
													...
													<td>
														...
														<!--	<input type="text" class="form-control"  name="remarks" id="remarks1" placeholder="Dept Head Remarks" required>-->
														<input type="text" class="form-control rec"
															value="{{date('d-F-Y', strtotime(@$gatepassv->safety_training_date))}}"
															autocomplete="off" readonly>
													</td>
												</tr>
												<tr>
													...
													<td>
														...
														<input type="text" class="form-control rec"
															value="{{date('H:i:s', strtotime(@$gatepassv->safety_training_time))}}"
															autocomplete="off" readonly>
													</td>
												</tr>
												...
												<tr>
													...
													<td>
														...
														@if($gatepassv->safety_datetime2 == '')

															<input type="text" class="form-control rec"
																value="{{date('d-F-Y H:i:s A', strtotime(@$gatepassv->safety_datetime))}}"
																autocomplete="off" readonly>
														@else
															<input type="text" class="form-control rec"
																value="{{date('d-F-Y H:i:s A', strtotime(@$gatepassv->safety_datetime2))}}"
																autocomplete="off" readonly>
														@endif
													</td>
												</tr>
											...
											<table class="table table-bordered table-hover table-condensed">
												...
												<tr>
													...
													<td>
														...
														<!--	<input type="text" class="form-control"  name="remarks" id="remarks1" placeholder="Dept Head Remarks" required>-->
														<input type="text" class="form-control rec"
															value="{{@$gatepassv->safety_pass_no}}" autocomplete="off" readonly>
													</td>
												</tr>
												...
												<tr>
													...
													<td><input type="text" class="form-control" readonly name="" id=""
															autocomplete="off"
															value="{{ucfirst(@$gatepassv->safety_decision)}}">
													</td>
												...
												<tr>
													...
													<td>
														...
														<!--	<input type="text" class="form-control"  name="remarks" id="remarks1" placeholder="Dept Head Remarks" required>-->
														<input type="text" class="form-control rec"
															value="{{@$gatepassv->safety_remarks}}" autocomplete="off" readonly>
													</td>
												</tr>
										...
										<form class="form-horizontal" role="form" method="POST" autocomplete="off" id=""
											...
											<table class="table table-bordered table-hover table-condensed">
												...
												<tr>
													...
													<td><input type="text" class="form-control" readonly name="" id=""
															autocomplete="off"
															value="{{ucfirst(@$gatepassv->shift_incharge_decision)}}">
													</td>
												...
												<tr>
													...
													<td>
														...
														<!--	<input type="text" class="form-control"  name="remarks" id="remarks1" placeholder="Dept Head Remarks" required>-->
														<input type="text" class="form-control rec"
															value="{{@$gatepassv->shift_incharge_remarks}}" autocomplete="off"
															readonly>
													</td>
												</tr>
												...
												<tr>
													...
													<td>
														...
														<!--	<input type="text" class="form-control"  name="remarks" id="remarks1" placeholder="Dept Head Remarks" required>-->
														<input type="text" class="form-control rec"
															value="{{date('d-F-Y H:i:s A', strtotime(@$gatepassv->shift_incharge_datetime))}}"
															autocomplete="off" readonly>
													</td>
												</tr>
											</table>
										...
										<form class="form-horizontal" role="form" method="POST" autocomplete="off" id=""
											...
											<table class="table table-bordered table-hover table-condensed">
												...
												<tr>
													...
													<td><input type="text" class="form-control" readonly name="" id=""
															autocomplete="off"
															value="{{ucfirst(@$gatepassv->plant_head_decision)}}">
													</td>
												...
												<tr>
													...
													<td>
														...
														<!--	<input type="text" class="form-control"  name="remarks" id="remarks1" placeholder="Dept Head Remarks" required>-->
														<input type="text" class="form-control rec"
															value="{{@$gatepassv->plant_head_remarks}}" autocomplete="off"
															readonly>
													</td>
												</tr>
												...
												<tr>
													...
													<td>
														...
														<!--	<input type="text" class="form-control"  name="remarks" id="remarks1" placeholder="Dept Head Remarks" required>-->
														<input type="text" class="form-control rec"
															value="{{date('d-F-Y H:i:s A', strtotime(@$gatepassv->plant_head_datetime))}}"
															autocomplete="off" readonly>
													</td>
												</tr>
											</table>
