...
@section('content')
    <div class="container py-5">
        ...
        <div class="row justify-content-right">
            ...
            <form class="form-inline" autocomplete="off" action="{{ route('admin.ot_calculation') }}" method="POST">
                @csrf
                ...
                <div class="form-group mx-sm-2 mb-2">
                    <a href="{{ route('admin.ot_calculation') }}" class="btn btn-info d-block text-start"
