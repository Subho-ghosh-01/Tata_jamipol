...
@section('content')
                                ...
                                @foreach($gatepasss as $gatepass)
                                    ...
                                    <tr
                                        ...
                                        <td>
                                            ...
                                            @if((Session::get('clm_role') == 'hr_dept' || Session::get('user_sub_typeSession') == 3) && $gatepass->status == "Pending_for_security")
                                        ...
                                        <td>
                                            ...
                                            @if($gatepasss->status == "Pending_for_security" && (Session::get('clm_role') == 'security' || Session::get('vms_role') == 'Security'))
                                                <a class="btn btn-info btn-sm"
                                                    ...
                                                    title="Edit">Print</a>
                                            @endif
                                            @if(Session::get('clm_role') == 'hr_dept' && $gatepasss->status == "Pending_for_security")
                                                <button type="button" class="btn btn-primary btn-sm" data-bs-toggle="modal"
                                                    data-emp_pno="{{ @$gatepasss->emp_pno }}" data-emp_name="{{@$gatepasss->name}}"
                                                    data-bs-target="#myModal" id="attendance">
                                                    Check Attendance
                                                </button>
                                            @endif
    ...
    <script>
        ...
        $(document).on('click', '.update-btn', function () {
            ...
            var path = "{{ route('admin.updateAttendance') }}/" + day + "/" + newStatus + "/" + empPno + "/" + month + "/" + year + "/" + otHours;
