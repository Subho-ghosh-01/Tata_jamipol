...
@section('content')
    <div class="container py-5">
        ...
        <div class="row justify-content-right">
            ...
            <form class="form-inline" autocomplete="off" action="{{ route('admin.daily_attendence_view') }}" method="POST">
                @csrf
                ...
                <div class="form-group mx-sm-2 mb-2">
                    <a href="{{ route('admin.daily_attendence_view') }}" class="btn btn-info d-block text-start"
