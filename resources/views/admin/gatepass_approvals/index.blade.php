...
@section('breadcrumbs')
    ...
    <li class="breadcrumb-item active" aria-current="page">List of Visitor's GatePass </a></li>
@endsection
@section('content')
...
<div class="modal fade" id="c_permit" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Cancel the Permit</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            ...
            <div class="modal-body">
                <input type="hidden" id="pid" name="pid">
                    @csrf
                    <div class="form-group">
                        <label for="Violation" class="col-form-label">Violation Details</label>
                    ...
                    <div class="form-group">
                        ...
                        <input type="file" class="form-control" name="img1" id="Upload 1" required>
                    </div>
                    <div class="form-group">
                        <label for="Upload 2" class="col-form-label">File Upload 2:</label>
                        <input type="file" class="form-control" name="img2" id="Upload 2" required>
                    </div>
                    <div class="form-group">
                        <label for="Upload 3" class="col-form-label">File Upload 3:</label>
                        <input type="file" class="form-control" name="img3" id="Upload 3" required>
                    </div>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                <input type="submit" class="btn btn-primary" value="Cancel Permit">
            </div>
            </form>
        </div>
    </div>
