    ...
    @section('content')
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
            ...
            <div class="btn-toolbar mb-2 mb-md-0">
                @if(Session::get('clm_role') != 'Account_dept')
                    <a href="{{ route('admin.vendor_attendance.create') }}"
                    ...
                    @if($attendance_lists->count() > 0)
                        ...
                        @foreach($attendance_lists as $attendance_list)
                            ...
                            <tr style="white-space: nowrap;">
                                ...
                                <td>{{date('F-Y ', strtotime($attendance_list->month))}}</td>
                                <td><a href="../{{$attendance_list->document}}" target="_blank" class="btn btn-success btn-sm">View /
                                        Download</a>
                                </td>
                                <td><a href="../{{$attendance_list->bank_document}}" target="_blank" class="btn btn-success btn-sm">View
                                        /
                                        Download</a>
                                </td>
                                <td>{!! $status !!}</td>
                                <td>{{date('d-m-Y H:i:s', strtotime(@$attendance_list->created_date))}} </td>
                                <td>
                                    @if(Session::get('clm_role') != 'Account_dept')
                                        <a href="{{ route('admin.vendor_attendance.edit', \Crypt::encrypt($attendance_list->id)) }}"
