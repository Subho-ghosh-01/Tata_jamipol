                            ...
                            @foreach($gate_pass_details as $key => $value)
                                <tr>
                                    ...
                                    <td><input type="text" class="form-control"  value="{{$gate_pass_details[$key]->expirydate}}" readonly="readonly"></td>
                                       ...
                                       <?php
                if($gate_pass_details[$key]->outtime)
                    {
                                       ?>
                                        <td><input type="text" class="form-control" readonly="readonly" value="{{$gate_pass_details[$key]->outtime}}"></td>
                                     <?php
                     }else{
                     ?>
               <td><input type="time" class="form-control"   name="outtime_time" ></td>
