	...
	<tr>
		...
		<table border="1" width="100%" cellspacing="0" cellpadding="0" bordercolor="#000000">
			...
			<tr>
				...
				<td><font face="Arial" size="2">@if($gate_pass_details[$key]->intime) {{date('h:i A', strtotime($gate_pass_details[$key]->intime))}}  @endif</font></td>
				<td><font face="Arial" size="2">@if($gate_pass_details[$key]->outtime)   {{date('h:i A', strtotime($gate_pass_details[$key]->outtime))}}
            @endif</font></td>
				<td>&nbsp;</td>
				<td>&nbsp;</td>
			</tr>
