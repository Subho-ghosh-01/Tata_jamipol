...
@section('breadcrumbs')
    ...
    <li class="breadcrumb-item"><a href="{{route('admin.division.index')}}">List of Silo Filed</a></li>
...
@else
    @section('content')
        <form id="fieldMasterForm" action="{{route('admin.silo_master.store')}}" method="POST" autocomplete="off">
            @csrf
