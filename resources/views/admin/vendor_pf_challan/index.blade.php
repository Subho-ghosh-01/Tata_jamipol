    ...
    @section('content')
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
            ...
            <div class="btn-toolbar mb-2 mb-md-0">
                <a href="{{ route('admin.vendor_pf_details.create') }}"
                    ...
                    @if($pf_lists->count() > 0)
                        ...
                        @foreach($pf_lists as $pf_list)
                            ...
                            <tr style="white-space: nowrap;">
                                ...
                                <td>{{date('F-Y ', strtotime($pf_list->month))}}</td>
                                <td><a href="../{{$pf_list->pf_challan}}" target="_blank" class="btn btn-success btn-sm">View /
                                        Download</a>
                                </td>
                                <td><a href="../{{$pf_list->ecr}}" target="_blank" class="btn btn-success btn-sm">View /
                                        Download</a>
                                </td>
                                <td>{!! $status !!}</td>
                                <td>{{date('d-m-Y H:i:s', strtotime(@$pf_list->created_date))}} </td>
                                <td>
                                    <a href="{{ route('admin.vendor_pf_details.edit', \Crypt::encrypt($pf_list->id)) }}"
