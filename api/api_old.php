    ...
    switch ($api) {
        case 'login':
            ...
            $userlogin = sqlsrv_fetch_array(sqlsrv_query($sqlcon, "SELECT id,name,
                user_type,division_id,department_id,user_sub_type,vms,vms_roll,clm,clm_role,clms_admin,safety,safety_role,safety_admin,wps
        ...
        case 'viewReport':
           ...
           $visitor_company = $_REQUEST['visitor_company'];
           $visitor_email = $_REQUEST['visitor_email'];
           $visitor_emergency_contact_no = $_REQUEST['visitor_emergency_contact_no'];
           $blood_group = $_REQUEST['blood_group'];
           $upload_photo= $_REQUEST['upload_photo'];
           ...
           $any_material =$_REQUEST['any_material'];
          ...
          // $purpose_of_material_entry = serialize($_REQUEST['purpose_of_material_entry']);
           $visitor_coming_by_any_vehicle = $_REQUEST['visitor_coming_by_any_vehicle'];
           $driving_mode = $_REQUEST['driving_mode'];
...
foreach($material_details as $key => $value) {
              $material_name = serialize($value['material_name']);
           $material_idenrification_no = serialize($value['material_idenrification_no']);
           $returnable = serialize($value['returnable']);
           $purpose_of_material_entry = serialize($value['purpose_of_material_entry']);
...
$vms_view  = sqlsrv_query($sqlcon,"SELECT * FROM (
    ...
    SELECT  visitor_gate_pass.*, ROW_NUMBER() OVER (ORDER BY visitor_gate_pass.id DESC) as row  FROM visitor_gate_pass  where division_id='$division' AND created_by='$session_id'  AND status='Pending_to_approve' ) a WHERE a.row >= '$start' and a.row <= '$end'");
...
$vms_view  = sqlsrv_query($sqlcon,"SELECT * FROM (
  ...
  SELECT  visitor_gate_pass.*, ROW_NUMBER() OVER (ORDER BY visitor_gate_pass.id DESC) as row  FROM visitor_gate_pass  where division_id='$division' AND created_by='$session_id'  AND (status='issued'  OR status='Rejected' OR status='Completed' ) ) a WHERE a.row >= '$start' and a.row <= '$end'");
...
$vms_view  = sqlsrv_query($sqlcon,"SELECT * FROM (
   ...
   SELECT  visitor_gate_pass.*, ROW_NUMBER() OVER (ORDER BY visitor_gate_pass.id DESC) as row visitor_gate_pass where division_id='$division' AND approver='$session_id' AND (status='issued'  OR status='Rejected' OR status='Completed')) a WHERE a.row >= '$start' and a.row <= '$end'");
...
// Compair valid Till Date start 
if($medical_examination_date > $police_verification_date && $medical_examination_date > $work_order_validity){

     $till_date=$medical_examination_date;

}else if($medical_examination_date < $police_verification_date && $work_order_validity < $police_verification_date){
...
$clms_view  = sqlsrv_query($sqlcon,"SELECT * FROM (
   ...
   SELECT Clms_gatepass.*, ROW_NUMBER() OVER (ORDER BY Clms_gatepass.id DESC) as row  FROM Clms_gatepass where division='$division' AND status='Pending_for_hr' ) a WHERE a.row >= '$start' and a.row <= '$end'");
...
$clms_view  = sqlsrv_query($sqlcon,"SELECT * FROM (
      SELECT Clms_gatepass.*, ROW_NUMBER() OVER (ORDER BY Clms_gatepass.id DESC) as row  FROM Clms_gatepass where division='$division' AND status='Pending_for_safety' ) a WHERE a.row >= '$start' and a.row <= '$end'");
...
}else if($clms_role=='Shift_incharge'){

$clms_view  = sqlsrv_query($sqlcon,"SELECT * FROM (
   SELECT Clms_gatepass.*, ROW_NUMBER() OVER (ORDER BY Clms_gatepass.id DESC) as row  FROM  Clms_gatepass where division='$division' AND status='Pending_for_shift_incharge' ) a  WHERE a.row >= '$start' and a.row <= '$end'");

//$clms_view  = sqlsrv_query($sqlcon,"SELECT * FROM Clms_gatepass where division='$division' AND //status='Pending_for_shift_incharge' ORDER BY id DESC");
}else if($clms_role=='plant_head'){

$clms_view  = sqlsrv_query($sqlcon,"SELECT * FROM (

   SELECT Clms_gatepass.*, ROW_NUMBER() OVER (ORDER BY Clms_gatepass.id DESC) as row  FROM  Clms_gatepass where division='$division' AND status='Pending_for_plant_head' ) a  WHERE a.row >= '$start' and a.row <= '$end'");
...
$clms_view  = sqlsrv_query($sqlcon,"SELECT * FROM (
   ...
   SELECT Clms_gatepass.*, ROW_NUMBER() OVER (ORDER BY Clms_gatepass.id DESC) as row  FROM Clms_gatepass where division='$division' AND shift_incharge_by='$session_id' ) a WHERE a.row >= '$start' and a.row <= '$end'");


//$clms_view  = sqlsrv_query($sqlcon,"SELECT * FROM Clms_gatepass where division='$division' AND //shift_incharge_by='$session_id' ORDER BY id DESC");
...
$response['upload_id_proof_front']=$row['upload_id_proof'];
$response['upload_id_proof_back']=$row['upload_id_proof_back'];
$response['education']=$row['education'];
$response['board_name']=$row['boared_name'];
$response['upload_result']=$row['upload_result'];
$response['uan_no']=$row['uan_no'];
$response['uan_document']=$row['uan_document'];
$response['esic']=$row['esic'];
$response['esic_document']=$row['esic_document'];
$response['blood_group']=$row['blood_group'];
$response['medical_examination_date']=$row['medical_examination_date'];
$response['upload_fittenss_copy']=$row['upload_fittenss_copy'];
$response['police_verification_date']=$row['police_verification_date'];
$response['police_verification_copy']=$row['police_verification_copy'];
...
$response['shift_incharge_id']=$row['shift_incharge_by'];
$shift_incharge_by=$row['shift_incharge_by'];
$sif_n = sqlsrv_query($sqlcon,"SELECT * FROM userlogins where id='$shift_incharge_by'");  
$sif_in = sqlsrv_fetch_array($sif_n);
$response['shift_incharge_name']=$sif_in['name'];
$response['shift_incharge_remarks']=$row['shift_incharge_remarks'];  
$response['shift_incharge_decision']=$row['shift_incharge_decision'];
$response['shift_incharge_datetime']=$row['shift_incharge_datetime'];
$response['safety_no']=$row['safety_no'];
...
$division=$row['division'];
         ...
         }else if($clms_role=='Shift_incharge' && $status=='Pending_for_shift_incharge' && $div==$division){
                   $response['Pending_Role']='Shift_incharge';
...
}else if($pending_role=='Shift_incharge') {
...
$query = "UPDATE Clms_gatepass 
                        SET
                             shift_incharge_by      ='$user_id',
                             shift_incharge_datetime      = '$date',
                             shift_incharge_remarks       = '$remarks',
                             shift_incharge_decision      = '$decision',
                             status                   ='$status'
                             WHERE id='$id'";
...
$safety_date  = sqlsrv_query($sqlcon,"SELECT * FROM (
   ...
   SELECT safety_data_entry.*, ROW_NUMBER() OVER (ORDER BY safety_data_entry.id DESC) as row  FROM safety_data_entry ) a WHERE a.row >= '$start' and a.row <= '$end'");
...
$safety_date  = sqlsrv_query($sqlcon,"SELECT * FROM (
    ...
    SELECT safety_data_entry.*, ROW_NUMBER() OVER (ORDER BY safety_data_entry.id DESC) as row  FROM safety_data_entry where division_id='$div' AND created_by='$session_id') a WHERE a.row >= '$start' and a.row <= '$end'");
...
$response['month']=date('M',strtotime($row['month']));
$division=$row['division_id'];
...
$response['q1']=$row['q1']; 
$response['q1_upload']=$row['q1_upload'];
$response['q2']=$row['q2'];
$response['q2_upload']=$row['q2_upload'];
$response['q3']=$row['q3_upload'];
$response['q4']=$row['q4'];
$response['q4_upload']=$row['q4_upload'];
$response['q5']=$row['q5'];
$response['q5_upload']=$row['q5_upload'];
$response['q6']=$row['q6'];
$response['q6_upload']=$row['q6_upload'];
$response['q7']=$row['q7'];
$response['q7_upload']=$row['q7_upload'];
$response['q8']=$row['q8'];
$response['q8_upload']=$row['q8_upload'];
$response['q9']=$row['q9'];
$response['q9_upload']=$row['q9_upload'];
$response['q10']=$row['q10'];
$response['q10_upload']=$row['q10_upload'];
$response['q11']=$row['q11'];
$response['q11_upload']=$row['q11_upload'];
$response['q12']=$row['q12'];
$response['q12_upload']=$row['q12_upload'];
$response['q13']=$row['q13'];
$response['q13_upload']=$row['q13_upload'];
$response['q14']=$row['q14'];
$response['q14_upload']=$row['q14_upload'];
$response['q15']=$row['q15'];
$response['q15_upload']=$row['q15_upload'];
$response['q16']=$row['q16'];
$response['q16_upload']=$row['q16_upload'];
$response['q17']=$row['q17'];
$response['q17_upload']=$row['q17_upload'];
$response['q18']=$row['q18'];
$response['q18_upload']=$row['q18_upload'];
$response['T1']=$row['T1'];
$response['T2']=$row['T2'];
$response['T3']=$row['T3'];
$response['T4']=$row['T4'];
